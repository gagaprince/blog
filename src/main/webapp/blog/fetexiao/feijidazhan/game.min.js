...
-1!=k.indexOf("android");var m=g.language,m=(m=m?m:g.browserLanguage)?m.split("-")[0]:c.LANGUAGE_ENGLISH;c.language=m;var m=c.BROWSER_TYPE_UNKNOWN,q=k.match(/micromessenger|qqbrowser|mqqbrowser|ucbrowser|360browser|baiduboxapp|baidubrowser|maxthon|trident|opera|miuibrowser|firefox/i)||k.match(/chrome|safari/i);q&&0<q.length&&(m=q[0].toLowerCase(),"micromessenger"==m?m=c.BROWSER_TYPE_WECHAT:"safari"===m&&k.match(/android.*applewebkit/)?m=c.BROWSER_TYPE_ANDROID:"trident"==m&&(m=c.BROWSER_TYPE_IE));
c.browserType=m;c._supportMultipleAudio=-1<e.indexOf(c.browserType);e=parseInt(a[b.renderMode]);m=cc._RENDER_TYPE_WEBGL;q=cc.newElement("Canvas");cc._supportRender=!0;d=-1==d.indexOf(c.browserType);if(1===e||0===e&&(c.isMobile||d))m=cc._RENDER_TYPE_CANVAS;m!=cc._RENDER_TYPE_WEBGL||f.WebGLRenderingContext&&cc.create3DContext(q,{stencil:!0,preserveDrawingBuffer:!0})||(0==e?m=cc._RENDER_TYPE_CANVAS:cc._supportRender=!1);if(m==cc._RENDER_TYPE_CANVAS)try{q.getContext("2d")}catch(n){cc._supportRender=!1}cc._renderType=
...
c=b.config,d=b.CONFIG_KEY,e=c[d.engineDir],f=cc.loader;if(cc._supportRender){b._prepareCalled=!0;var g=c[d.jsList]||[];cc.Class?f.loadJsWithImg("",g,function(c){if(c)throw c;b._prepared=!0;a&&a()}):(d=cc.path.join(e,"moduleConfig.json"),f.loadJson(d,function(d,f){if(d)throw d;var m=c.modules||[],q=f.module,n=[];cc._renderType==cc._RENDER_TYPE_WEBGL?m.splice(0,0,"shaders"):0>m.indexOf("core")&&m.splice(0,0,"core");for(var r=0,s=m.length;r<s;r++){var t=b._getJsListOfModule(q,m[r],e);t&&(n=n.concat(t))}n=
...
cc._loaderImage="data:image/png;base64,";var cc=cc||{},ClassManager={id:0|998*Math.random(),instanceId:0|998*Math.random(),compileSuper:function(a,b,c){a=a.toString();var d=a.indexOf("("),e=a.indexOf(")"),d=a.substring(d+1,e),d=d.trim(),e=a.indexOf("{"),f=a.lastIndexOf("}");for(a=a.substring(e+1,f);-1!=a.indexOf("this._super");){var e=a.indexOf("this._super"),f=a.indexOf("(",e),g=a.indexOf(")",f),g=a.substring(f+1,g),g=(g=g.trim())?",":"";a=a.substring(0,e)+"ClassManager["+c+"]."+b+".call(this"+g+a.substring(f+1)}return Function(d,a)},getNewID:function(){return this.id++},
...
Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,m=arguments.length;k<m;++k){var q=arguments[k],n;for(n in q){var r="function"===typeof q[n],s="function"===typeof e[n],t=a.test(q[n]);b&&r&&s&&t?(h.value=ClassManager.compileSuper(q[n],n,g),Object.defineProperty(f,n,h)):r&&s&&t?(h.value=function(a,b){return function(){var c=this._super;this._super=e[a];var d=b.apply(this,
arguments);this._super=c;return d}}(n,q[n]),Object.defineProperty(f,n,h)):r?(h.value=q[n],Object.defineProperty(f,n,h)):f[n]=q[n];if(r){var u,w;if(this.__getters__&&this.__getters__[n]){var r=this.__getters__[n],v;for(v in this.__setters__)if(this.__setters__[v]==r){w=v;break}cc.defineGetterSetter(f,r,q[n],q[w]?q[w]:f[w],n,w)}if(this.__setters__&&this.__setters__[n]){r=this.__setters__[n];for(v in this.__getters__)if(this.__getters__[v]==r){u=v;break}cc.defineGetterSetter(f,r,q[u]?q[u]:f[u],q[n],
u,n)}}}}d.extend=cc.Class.extend;d.implement=function(a){for(var b in a)f[b]=a[b]};return d};Function.prototype.bind=Function.prototype.bind||function(a){var b=this;return function(){var e=Array.prototype.slice.call(arguments);return b.apply(a||null,e)}}})();
cc.defineGetterSetter=function(a,b,c,d,e,f){if(a.__defineGetter__)c&&a.__defineGetter__(b,c),d&&a.__defineSetter__(b,d);else if(Object.defineProperty){var g={enumerable:!1,configurable:!0};c&&(g.get=c);d&&(g.set=d);Object.defineProperty(a,b,g)}else throw Error("browser does not support getters");if(!e&&!f)for(var g=null!=c,h=void 0!=d,k=Object.getOwnPropertyNames(a),m=0;m<k.length;m++){var q=k[m];if((a.__lookupGetter__?!a.__lookupGetter__(q):!Object.getOwnPropertyDescriptor(a,q))&&"function"===typeof a[q]){var n=
a[q];if(g&&n===c&&(e=q,!h||f))break;if(h&&n===d&&(f=q,!g||e))break}}a=a.constructor;e&&(a.__getters__||(a.__getters__={}),a.__getters__[e]=b);f&&(a.__setters__||(a.__setters__={}),a.__setters__[f]=b)};cc.clone=function(a){var b=a.constructor?new a.constructor:{},c;for(c in a){var d=a[c];b[c]="object"!=typeof d||!d||d instanceof cc.Node||d instanceof HTMLElement?d:cc.clone(d)}return b};cc=cc||{};cc._tmp=cc._tmp||{};cc.associateWithNative=function(a,b){};
...
(function(){var a=cc.ContainerStrategy.extend({apply:function(a){this._setupContainer(a,a._frameSize.width,a._frameSize.height)}}),b=cc.ContainerStrategy.extend({apply:function(a,b){var c=a._frameSize.width,d=a._frameSize.height,e=cc.container.style,q=b.width,n=b.height,r=c/q,s=d/n,t,u;r<s?(t=c,u=n*r):(t=q*s,u=d);q=Math.round((c-t)/2);u=Math.round((d-u)/2);this._setupContainer(a,c-2*q,d-2*u);e.marginLeft=q+"px";e.marginRight=q+"px";e.marginTop=u+"px";e.marginBottom=u+"px"}});a.extend({preApply:function(a){this._super(a);
...
b){var c=cc._canvas.width,d=cc._canvas.height;return this._buildResult(c,d,c,d,c/b.width,d/b.height)}}),b=cc.ContentStrategy.extend({apply:function(a,b){var c=cc._canvas.width,d=cc._canvas.height,e=b.width,q=b.height,n=c/e,r=d/q,s=0,t,u;n<r?(s=n,t=c,u=q*s):(s=r,t=e*s,u=d);return this._buildResult(c,d,t,u,s,s)}}),c=cc.ContentStrategy.extend({apply:function(a,b){var c=cc._canvas.width,d=cc._canvas.height,e=b.width,q=b.height,n=c/e,r=d/q,s,t,u;n<r?(s=r,t=e*s,u=d):(s=n,t=c,u=q*s);return this._buildResult(c,
...
cc.pSubIn=function(a,b){a.x-=b.x;a.y-=b.y};cc.pAddIn=function(a,b){a.x+=b.x;a.y+=b.y};cc.pNormalizeIn=function(a){cc.pMultIn(a,1/Math.sqrt(a.x*a.x+a.y*a.y))};cc.vertexLineToPolygon=function(a,b,c,d,e){e+=d;if(!(1>=e)){b*=0.5;for(var f,g=e-1,h=d;h<e;h++){f=2*h;var k=cc.p(a[2*h],a[2*h+1]),m;if(0===h)m=cc.pPerp(cc.pNormalize(cc.pSub(k,cc.p(a[2*(h+1)],a[2*(h+1)+1]))));else if(h===g)m=cc.pPerp(cc.pNormalize(cc.pSub(cc.p(a[2*(h-1)],a[2*(h-1)+1]),k)));else{m=cc.p(a[2*(h-1)],a[2*(h-1)+1]);var q=cc.p(a[2*(h+1)],a[2*(h+1)+1]),n=cc.pNormalize(cc.pSub(q,k)),r=cc.pNormalize(cc.pSub(m,k)),s=Math.acos(cc.pDot(n,r));m=s<cc.degreesToRadians(70)?cc.pPerp(cc.pNormalize(cc.pMidpoint(n,
r))):s<cc.degreesToRadians(170)?cc.pNormalize(cc.pMidpoint(n,r)):cc.pPerp(cc.pNormalize(cc.pSub(q,m)))}m=cc.pMult(m,b);c[2*f]=k.x+m.x;c[2*f+1]=k.y+m.y;c[2*(f+1)]=k.x-m.x;c[2*(f+1)+1]=k.y-m.y}for(h=0==d?0:d-1;h<g;h++)f=2*h,a=f+2,b=cc.vertex2(c[2*f],c[2*f+1]),e=cc.vertex2(c[2*(f+1)],c[2*(f+1)+1]),f=cc.vertex2(c[2*a],c[2*a]),d=cc.vertex2(c[2*(a+1)],c[2*(a+1)+1]),b=!cc.vertexLineIntersect(b.x,b.y,d.x,d.y,e.x,e.y,f.x,f.y),!b.isSuccess&&(0>b.value||1<b.value)&&(b.isSuccess=!0),b.isSuccess&&(c[2*a]=d.x,
...
b=this._position.y,c=this._anchorPointInPoints.x,d=-c,e=this._anchorPointInPoints.y,f=-e,g=this._scaleX,h=this._scaleY;this._ignoreAnchorPointForPosition&&(a+=c,b+=e);var k=1,m=0,q=1,n=0;if(0!==this._rotationX||0!==this._rotationY)k=Math.cos(-this._rotationRadiansX),m=Math.sin(-this._rotationRadiansX),q=Math.cos(-this._rotationRadiansY),n=Math.sin(-this._rotationRadiansY);var r=this._skewX||this._skewY;r||0===c&&0===e||(a+=q*d*g+-m*f*h,b+=n*d*g+k*f*h);var s=this._transform;s.a=q*g;s.b=n*g;s.c=-m*
...
f=this._anchorPointInPoints.x,g=this._anchorPointInPoints.y,h=1E-6>d&&-1E-6<d?1E-6:d,k=1E-6>e&&-1E-6<e?1E-6:e;if(this._skewX||this._skewY){var m=Math.tan(-this._skewX*Math.PI/180),q=Math.tan(-this._skewY*Math.PI/180);Infinity===m&&(m=99999999);Infinity===q&&(q=99999999);var n=g*m*h,r=f*q*k;a.a=b+-c*q;a.b=b*m+-c;a.c=c+b*q;a.d=c*m+b;a.tx+=b*n+-c*r;a.ty+=c*n+b*r}if(1!==d||1!==e)a.a*=h,a.c*=h,a.b*=k,a.d*=k;a.tx+=b*-f*h+-c*g*k;a.ty-=c*-f*h+b*g*k;this._ignoreAnchorPointForPosition&&(a.tx+=f,a.ty+=g);this._additionalTransformDirty&&
...
a);return-1},_initPremultipliedATextureWithImage:function(a,b,c){var d=cc.Texture2D,e=a.getData(),f=null,f=null,g=a.hasAlpha(),h=cc.size(a.getWidth(),a.getHeight()),k=d.defaultPixelFormat,m=a.getBitsPerComponent();g||(8<=m?k=d.PIXEL_FORMAT_RGB888:(cc.log(cc._LogInfos.Texture2D__initPremultipliedATextureWithImage),k=d.PIXEL_FORMAT_RGB565));var q=b*c;if(k==d.PIXEL_FORMAT_RGB565)if(g)for(e=new Uint16Array(b*c),f=a.getData(),m=0;m<q;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>2<<5|(f[m]>>16&255)>>3<<
0;else for(e=new Uint16Array(b*c),f=a.getData(),m=0;m<q;++m)e[m]=(f[m]&255)>>3<<11|(f[m]&255)>>2<<5|(f[m]&255)>>3<<0;else if(k==d.PIXEL_FORMAT_RGBA4444)for(e=new Uint16Array(b*c),f=a.getData(),m=0;m<q;++m)e[m]=(f[m]>>0&255)>>4<<12|(f[m]>>8&255)>>4<<8|(f[m]>>16&255)>>4<<4|(f[m]>>24&255)>>4<<0;else if(k==d.PIXEL_FORMAT_RGB5A1)for(e=new Uint16Array(b*c),f=a.getData(),m=0;m<q;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>3<<6|(f[m]>>16&255)>>3<<1|(f[m]>>24&255)>>7<<0;else if(k==d.PIXEL_FORMAT_A8)for(e=
new Uint8Array(b*c),f=a.getData(),m=0;m<q;++m)e[m]=f>>24&255;if(g&&k==d.PIXEL_FORMAT_RGB888)for(f=a.getData(),e=new Uint8Array(b*c*3),m=0;m<q;++m)e[3*m]=f>>0&255,e[3*m+1]=f>>8&255,e[3*m+2]=f>>16&255;this.initWithData(e,k,b,c,h);a.getData();this._hasPremultipliedAlpha=a.isPremultipliedAlpha();return!0},addLoadedEventListener:function(a,b){this._loadedEventListeners||(this._loadedEventListeners=[]);this._loadedEventListeners.push({eventCallback:a,eventTarget:b})},removeLoadedEventListener:function(a){if(this._loadedEventListeners)for(var b=
...
"texture",a.getTexture,a.setTexture);cc.defineGetterSetter(a,"textureRectRotated",a.isTextureRectRotated);cc.defineGetterSetter(a,"batchNode",a.getBatchNode,a.setBatchNode);cc.defineGetterSetter(a,"quad",a.getQuad)};cc.generateTextureCacheForColor=function(a){function b(){var b=cc.generateTextureCacheForColor,d=a.width,g=a.height;c[0].width=d;c[0].height=g;c[1].width=d;c[1].height=g;c[2].width=d;c[2].height=g;c[3].width=d;c[3].height=g;b.canvas.width=d;b.canvas.height=g;var h=b.canvas.getContext("2d");h.drawImage(a,0,0);b.tempCanvas.width=d;b.tempCanvas.height=g;for(var h=h.getImageData(0,0,d,g).data,k=0;4>k;k++){var m=c[k].getContext("2d");m.getImageData(0,0,d,g).data;b.tempCtx.drawImage(a,0,0);for(var q=b.tempCtx.getImageData(0,
0,d,g),n=q.data,r=0;r<h.length;r+=4)n[r]=0===k?h[r]:0,n[r+1]=1===k?h[r+1]:0,n[r+2]=2===k?h[r+2]:0,n[r+3]=h[r+3];m.putImageData(q,0,0)}a.onload=null}if(a.channelCache)return a.channelCache;var c=[cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas")];try{b()}catch(d){a.onload=b}return a.channelCache=c};cc.generateTextureCacheForColor.canvas=cc.newElement("canvas");cc.generateTextureCacheForColor.tempCanvas=cc.newElement("canvas");
...
this._fontStyleStr},_measure:function(a){return this._getLabelContext().measureText(a).width},_checkNextline:function(a,b){var c=this._measure(a),d=Math.floor(a.length*b/c),e=a.indexOf("\n");if(0.8*d>=e&&0<e)return e+1;if(c<b)return a.length;for(var c=!1,f=b+1,e=-1,g=d,h,k=cc.LabelTTF._checkRegEx,m=cc.LabelTTF._reverseCheckRegEx,q=cc.LabelTTF._checkEnRegEx,n=a.substr(d);h=k.exec(n);){g+=h[0].length;f=a.substr(0,g);f=this._measure(f);if("\n"==h[2]&&f<b){c=!0;e=g;break}if(f>b){-1!=e&&(c=!0);break}e=
g;n=a.substr(g)}if(c)return e;n=a.substr(0,d);for(e=d;h=m.exec(n);)if(e=h[1].length,n=h[1],f=this._measure(n),f<b){q.test(h[2])&&e++;break}return e||1},description:function(){return"\x3ccc.LabelTTF | FontName \x3d"+this._fontName+" FontSize \x3d "+this._fontSize.toFixed(1)+"\x3e"},setColor:null,_setColorsString:null,updateDisplayedColor:null,setOpacity:null,updateDisplayedOpacity:null,updateDisplayedOpacityForCanvas:function(a){cc.NodeRGBA.prototype.updateDisplayedOpacity.call(this,a);this._setColorsString()},
...
cc.kmRay2IntersectTriangle=function(a,b,c,d,e,f){var g=new cc.kmVec2,h=new cc.kmVec2,k=new cc.kmVec2,m=1E4,q=cc.KM_FALSE,n;cc.kmRay2IntersectLineSegment(a,b,c,g)&&(n=new cc.kmVec2,q=cc.KM_TRUE,n=cc.kmVec2Length(cc.kmVec2Subtract(n,g,a.start)),n<m&&(h.x=g.x,h.y=g.y,m=n,cc.calculate_line_normal(b,c,k)));cc.kmRay2IntersectLineSegment(a,c,d,g)&&(n=new cc.kmVec2,q=cc.KM_TRUE,n=cc.kmVec2Length(cc.kmVec2Subtract(n,g,a.start)),n<m&&(h.x=g.x,h.y=g.y,m=n,cc.calculate_line_normal(c,d,k)));cc.kmRay2IntersectLineSegment(a,
d,b,g)&&(n=new cc.kmVec2,q=cc.KM_TRUE,n=cc.kmVec2Length(cc.kmVec2Subtract(n,g,a.start)),n<m&&(h.x=g.x,h.y=g.y,cc.calculate_line_normal(d,b,k)));q&&(e.x=h.x,e.y=h.y,f&&(f.x=k.x,f.y=k.y));return q};cc.kmRay2IntersectCircle=function(a,b,c,d){cc.log("cc.kmRay2IntersectCircle() has not been implemented.")};var Float32Array=Float32Array||Array;cc.kmMat3=function(){this.mat=new Float32Array([0,0,0,0,0,0,0,0,0])};cc.kmMat3Fill=function(a,b){for(var c=0;9>c;c++)a.mat[c]=b;return a};
...
cc.kmMat4Multiply=function(a,b,c){var d=a.mat,e=b.mat[0],f=b.mat[1],g=b.mat[2],h=b.mat[3],k=b.mat[4],m=b.mat[5],q=b.mat[6],n=b.mat[7],r=b.mat[8],s=b.mat[9],t=b.mat[10],u=b.mat[11],w=b.mat[12],v=b.mat[13],x=b.mat[14];b=b.mat[15];var y=c.mat[0],z=c.mat[1],A=c.mat[2],B=c.mat[3],C=c.mat[4],D=c.mat[5],E=c.mat[6],F=c.mat[7],G=c.mat[8],H=c.mat[9],I=c.mat[10],J=c.mat[11],K=c.mat[12],L=c.mat[13],M=c.mat[14];c=c.mat[15];d[0]=y*e+z*k+A*r+B*w;d[1]=y*f+z*m+A*s+B*v;d[2]=y*g+z*q+A*t+B*x;d[3]=y*h+z*n+A*u+B*b;d[4]=
C*e+D*k+E*r+F*w;d[5]=C*f+D*m+E*s+F*v;d[6]=C*g+D*q+E*t+F*x;d[7]=C*h+D*n+E*u+F*b;d[8]=G*e+H*k+I*r+J*w;d[9]=G*f+H*m+I*s+J*v;d[10]=G*g+H*q+I*t+J*x;d[11]=G*h+H*n+I*u+J*b;d[12]=K*e+L*k+M*r+c*w;d[13]=K*f+L*m+M*s+c*v;d[14]=K*g+L*q+M*t+c*x;d[15]=K*h+L*n+M*u+c*b;return a};
...
a);cc.LABELATLAS_DEBUG_DRAW&&(a=this.size,a=[cc.p(0,0),cc.p(a.width,0),cc.p(a.width,a.height),cc.p(0,a.height)],cc._drawingUtil.drawPoly(a,4,!0))},_addChildForCanvas:function(a,b,c){a._lateChild=!0;cc.NodeRGBA.prototype.addChild.call(this,a,b,c)},updateAtlasValues:null,_updateAtlasValuesForCanvas:function(){for(var a=this._string||"",b=a.length,c=this.texture,d=this._itemWidth,e=this._itemHeight,f=0;f<b;f++){var g=a.charCodeAt(f)-this._mapStartChar.charCodeAt(0),h=parseInt(g%this._itemsPerRow,10),
g=parseInt(g/this._itemsPerRow,10),h=cc.rect(h*d,g*e,d,e),g=a.charCodeAt(f),k=this.getChildByTag(f);k?32==g?(k.init(),k.setTextureRect(cc.rect(0,0,10,10),!1,cc.size(0,0))):(k.initWithTexture(c,h),k.visible=!0,k.opacity=this._displayedOpacity):(k=new cc.Sprite,32==g?(k.init(),k.setTextureRect(cc.rect(0,0,10,10),!1,cc.size(0,0))):k.initWithTexture(c,h),cc.NodeRGBA.prototype.addChild.call(this,k,0,f));k.setPosition(f*d+d/2,e/2)}},_updateAtlasValuesForWebGL:function(){var a=this._string,b=a.length,c=
this.textureAtlas,d=c.texture,e=d.pixelsWidth,d=d.pixelsHeight,f=this._itemWidth,g=this._itemHeight;this._ignoreContentScaleFactor||(f=this._itemWidth*cc.contentScaleFactor(),g=this._itemHeight*cc.contentScaleFactor());b>c.getCapacity()&&cc.log("cc.LabelAtlas._updateAtlasValues(): Invalid String length");for(var h=c.quads,k=this._displayedColor,k={r:k.r,g:k.g,b:k.b,a:this._displayedOpacity},m=this._itemWidth,q=0;q<b;q++){var n=a.charCodeAt(q)-this._mapStartChar.charCodeAt(0),r=n%this._itemsPerRow,
s=0|n/this._itemsPerRow,t;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(r=(2*r*f+1)/(2*e),n=r+(2*f-2)/(2*e),s=(2*s*g+1)/(2*d),t=s+(2*g-2)/(2*d)):(r=r*f/e,n=r+f/e,s=s*g/d,t=s+g/d);var u=h[q],w=u.tl,v=u.tr,x=u.bl,u=u.br;w.texCoords.u=r;w.texCoords.v=s;v.texCoords.u=n;v.texCoords.v=s;x.texCoords.u=r;x.texCoords.v=t;u.texCoords.u=n;u.texCoords.v=t;x.vertices.x=q*m;x.vertices.y=0;x.vertices.z=0;u.vertices.x=q*m+m;u.vertices.y=0;u.vertices.z=0;w.vertices.x=q*m;w.vertices.y=this._itemHeight;w.vertices.z=0;v.vertices.x=
q*m+m;v.vertices.y=this._itemHeight;v.vertices.z=0;w.colors=k;v.colors=k;x.colors=k;u.colors=k}0<b&&(c.dirty=!0,a=c.totalQuads,b>a&&c.increaseTotalQuadsWith(b-a))},setString:null,_setStringForCanvas:function(a){a=String(a);var b=a.length;this._string=a;this.width=b*this._itemWidth;this.height=this._itemHeight;if(this._children){a=this._children;for(var b=a.length,c=0;c<b;c++){var d=a[c];d&&!d._lateChild&&(d.visible=!1)}}this.updateAtlasValues();this.quadsToDraw=b},_setStringForWebGL:function(a){a=
String(a);var b=a.length;b>this.textureAtlas.totalQuads&&this.textureAtlas.resizeCapacity(b);this._string=a;this.width=b*this._itemWidth;this.height=this._itemHeight;this.updateAtlasValues();this.quadsToDraw=b},setOpacity:null,_setOpacityForCanvas:function(a){if(this._displayedOpacity!==a){cc.AtlasNode.prototype.setOpacity.call(this,a);for(var b=this._children,c=0,d=b.length;c<d;c++)b[c]&&(b[c].opacity=a)}},_setOpacityForWebGL:function(a){this._opacity!==a&&cc.AtlasNode.prototype.setOpacity.call(this,
a)}});_p=cc.LabelAtlas.prototype;cc._renderType===cc._RENDER_TYPE_WEBGL?(_p.updateAtlasValues=_p._updateAtlasValuesForWebGL,_p.setString=_p._setStringForWebGL,_p.setOpacity=_p._setOpacityForWebGL):(_p.updateAtlasValues=_p._updateAtlasValuesForCanvas,_p.setString=_p._setStringForCanvas,_p.setOpacity=_p._setOpacityForCanvas,_p.addChild=_p._addChildForCanvas);cc.defineGetterSetter(_p,"opacity",_p.getOpacity,_p.setOpacity);cc.defineGetterSetter(_p,"string",_p.getString,_p.setString);
cc.LabelAtlas.create=function(a,b,c,d,e){return new cc.LabelAtlas(a,b,c,d,e)};cc.LABEL_AUTOMATIC_WIDTH=-1;
cc.LabelBMFont=cc.SpriteBatchNode.extend({RGBAProtocol:!0,_opacityModifyRGB:!1,_string:"",_config:null,_fntFile:"",_initialString:"",_alignment:cc.TEXT_ALIGNMENT_CENTER,_width:-1,_lineBreakWithoutSpaces:!1,_imageOffset:null,_reusedChar:null,_displayedOpacity:255,_realOpacity:255,_displayedColor:null,_realColor:null,_cascadeColorEnabled:!0,_cascadeOpacityEnabled:!0,_textureLoaded:!1,_loadedEventListeners:null,_className:"LabelBMFont",_setString:function(a,b){b?this._initialString=a:this._string=a;
var c=this._children;if(c)for(var d=0;d<c.length;d++){var e=c[d];e&&e.setVisible(!1)}this._textureLoaded&&(this.createFontChars(),b&&this.updateLabel())},ctor:function(a,b,c,d,e){cc.SpriteBatchNode.prototype.ctor.call(this);this._imageOffset=cc.p(0,0);this._displayedColor=cc.color(255,255,255,255);this._realColor=cc.color(255,255,255,255);this._reusedChar=[];this.initWithString(a,b,c,d,e)},textureLoaded:function(){return this._textureLoaded},addLoadedEventListener:function(a,b){this._loadedEventListeners||
(this._loadedEventListeners=[]);this._loadedEventListeners.push({eventCallback:a,eventTarget:b})},_callLoadedEventCallbacks:function(){if(this._loadedEventListeners){for(var a=this._loadedEventListeners,b=0,c=a.length;b<c;b++){var d=a[b];d.eventCallback.call(d.eventTarget,this)}a.length=0}},draw:function(a){cc.SpriteBatchNode.prototype.draw.call(this,a);if(cc.LABELBMFONT_DEBUG_DRAW){a=this.getContentSize();var b=cc.p(0|-this._anchorPointInPoints.x,0|-this._anchorPointInPoints.y);a=[cc.p(b.x,b.y),
cc.p(b.x+a.width,b.y),cc.p(b.x+a.width,b.y+a.height),cc.p(b.x,b.y+a.height)];cc._drawingUtil.setDrawColor(0,255,0,255);cc._drawingUtil.drawPoly(a,4,!0)}},setColor:function(a){var b=this._displayedColor,c=this._realColor;if(c.r!=a.r||c.g!=a.g||c.b!=a.b||c.a!=a.a)b.r=c.r=a.r,b.g=c.g=a.g,b.b=c.b=a.b,this._textureLoaded&&this._cascadeColorEnabled&&(b=cc.color.WHITE,(c=this._parent)&&c.RGBAProtocol&&c.cascadeColor&&(b=c.getDisplayedColor()),this.updateDisplayedColor(b)),void 0===a.a||a.a_undefined||this.setOpacity(a.a)},
isOpacityModifyRGB:function(){return this._opacityModifyRGB},setOpacityModifyRGB:function(a){this._opacityModifyRGB=a;if(a=this._children)for(var b=0;b<a.length;b++){var c=a[b];c&&c.RGBAProtocol&&(c.opacityModifyRGB=this._opacityModifyRGB)}},getOpacity:function(){return this._realOpacity},getDisplayedOpacity:function(){return this._displayedOpacity},setOpacity:function(a){this._displayedOpacity=this._realOpacity=a;if(this._cascadeOpacityEnabled){var b=255,c=this._parent;c&&c.RGBAProtocol&&c.cascadeOpacity&&
(b=c.getDisplayedOpacity());this.updateDisplayedOpacity(b)}this._displayedColor.a=this._realColor.a=a},updateDisplayedOpacity:function(a){this._displayedOpacity=this._realOpacity*a/255;a=this._children;for(var b=0;b<a.length;b++){var c=a[b];cc._renderType==cc._RENDER_TYPE_WEBGL?c.updateDisplayedOpacity(this._displayedOpacity):(cc.NodeRGBA.prototype.updateDisplayedOpacity.call(c,this._displayedOpacity),c.setNodeDirty())}this._changeTextureColor()},isCascadeOpacityEnabled:function(){return!1},setCascadeOpacityEnabled:function(a){this._cascadeOpacityEnabled=
a},getColor:function(){var a=this._realColor;return cc.color(a.r,a.g,a.b,a.a)},getDisplayedColor:function(){return this._displayedColor},updateDisplayedColor:function(a){var b=this._displayedColor,c=this._realColor;b.r=c.r*a.r/255;b.g=c.g*a.g/255;b.b=c.b*a.b/255;a=this._children;for(b=0;b<a.length;b++)c=a[b],cc._renderType==cc._RENDER_TYPE_WEBGL?c.updateDisplayedColor(this._displayedColor):(cc.NodeRGBA.prototype.updateDisplayedColor.call(c,this._displayedColor),c.setNodeDirty());this._changeTextureColor()},
_changeTextureColor:function(){if(cc._renderType!=cc._RENDER_TYPE_WEBGL){var a,b=this.texture;b&&0<b.width&&(a=b.getHtmlElementObj())&&(b=cc.textureCache.getTextureColors(this._originalTexture.getHtmlElementObj()))&&(a instanceof HTMLCanvasElement&&!this._rectRotated?cc.generateTintImage(a,b,this._displayedColor,null,a):(a=cc.generateTintImage(a,b,this._displayedColor),b=new cc.Texture2D,b.initWithElement(a),b.handleLoadedTexture(),this.texture=b))}},isCascadeColorEnabled:function(){return!1},setCascadeColorEnabled:function(a){this._cascadeColorEnabled=
...
h=g?g.length:0;if(0!==h){var k,m=this._config,q=m.kerningDict,n=m.commonHeight,r=m.fontDefDictionary;for(k=0;k<h-1;k++)10==g.charCodeAt(k)&&f++;var s=n*f,f=-(n-n*f),t=-1;for(k=0;k<h;k++)if(n=g.charCodeAt(k),0!=n)if(10===n)c=0,f-=m.commonHeight;else{var u=q[t<<16|n&65535]||0,w=r[n];if(w){var v=cc.rect(w.rect.x,w.rect.y,w.rect.width,w.rect.height),v=cc.rectPixelsToPoints(v);v.x+=this._imageOffset.x;v.y+=this._imageOffset.y;(t=this.getChildByTag(k))?32===n&&a===cc._RENDER_TYPE_CANVAS?t.setTextureRect(v,
!1,cc.size(0,0)):(t.setTextureRect(v,!1),t.visible=!0):(t=new cc.Sprite,32===n&&a===cc._RENDER_TYPE_CANVAS&&(v=cc.rect(0,0,0,0)),t.initWithTexture(b,v,!1),t._newTextureWhenChangeColor=!0,this.addChild(t,0,k));t.opacityModifyRGB=this._opacityModifyRGB;cc._renderType==cc._RENDER_TYPE_WEBGL?(t.updateDisplayedColor(this._displayedColor),t.updateDisplayedOpacity(this._displayedOpacity)):(cc.NodeRGBA.prototype.updateDisplayedColor.call(t,this._displayedColor),cc.NodeRGBA.prototype.updateDisplayedOpacity.call(t,
this._displayedOpacity),t.setNodeDirty());v=cc.p(c+w.xOffset+0.5*w.rect.width+u,f+(m.commonHeight-w.yOffset)-0.5*v.height*cc.contentScaleFactor());t.setPosition(cc.pointPixelsToPoints(v));c+=w.xAdvance+u;t=n;e<c&&(e=c)}else cc.log("cocos2d: LabelBMFont: character not found "+g[k])}d.width=e;d.height=s;this.setContentSize(cc.sizePixelsToPoints(d))}},updateString:function(a){var b=this._children;if(b)for(var c=0,d=b.length;c<d;c++){var e=b[c];e&&(e.visible=!1)}this._config&&this.createFontChars();a||
this.updateLabel()},getString:function(){return this._initialString},setString:function(a,b){a=String(a);null==b&&(b=!0);if(null==a||"string"!=typeof a)a+="";this._initialString=a;this._setString(a,b)},_setStringForSetter:function(a){this.setString(a,!1)},setCString:function(a){this.setString(a,!0)},updateLabel:function(){this.string=this._initialString;if(0<this._width){for(var a=this._string.length,b=[],c=[],d=1,e=0,f=!1,g=!1,h=-1,k=-1,m=0,q,n=0,r=this._children.length;n<r;n++){for(var s=0;!(q=
this.getChildByTag(n+m+s));)s++;m+=s;if(e>=a)break;var t=this._string[e];g||(k=this._getLetterPosXLeft(q),g=!0);f||(h=k,f=!0);if(10==t.charCodeAt(0)){c.push("\n");b=b.concat(c);c.length=0;f=g=!1;h=k=-1;n--;m-=s;d++;if(e>=a)break;k||(k=this._getLetterPosXLeft(q),g=!0);h||(h=k,f=!0);e++}else if(cc.isspace_unicode(t))c.push(t),b=b.concat(c),c.length=0,g=!1,k=-1,e++;else if(this._getLetterPosXRight(q)-h>this._width)if(this._lineBreakWithoutSpaces){cc.utf8_trim_ws(c);c.push("\n");b=b.concat(c);c.length=
0;f=g=!1;h=k=-1;d++;if(e>=a)break;k||(k=this._getLetterPosXLeft(q),g=!0);h||(h=k,f=!0);n--}else c.push(t),-1!=b.lastIndexOf(" ")?cc.utf8_trim_ws(b):b=[],0<b.length&&b.push("\n"),d++,f=!1,h=-1,e++;else c.push(t),e++}b=b.concat(c);n=b.length;q="";for(e=0;e<n;++e)q+=b[e];q+=String.fromCharCode(0);this._setString(q,!1)}if(this._alignment!=cc.TEXT_ALIGNMENT_LEFT)for(b=e=0,a=this._string.length,c=[],d=0;d<a;d++)if(10==this._string[d].charCodeAt(0)||0==this._string[d].charCodeAt(0))if(n=0,f=c.length,0==
f)b++;else{if(q=e+f-1+b,!(0>q)&&(n=this.getChildByTag(q),null!=n)){n=n.getPositionX()+n._getWidth()/2;g=0;switch(this._alignment){case cc.TEXT_ALIGNMENT_CENTER:g=this.width/2-n/2;break;case cc.TEXT_ALIGNMENT_RIGHT:g=this.width-n}if(0!=g)for(n=0;n<f;n++)(q=e+n+b,0>q||!(q=this.getChildByTag(q)))||(q.x+=g);e+=f;b++;c.length=0}}else c.push(this._string[e])},setAlignment:function(a){this._alignment=a;this.updateLabel()},_getAlignment:function(){return this._alignment},setBoundingWidth:function(a){this._width=
...
16|b&65535).toString()];d&&(c=d.amount)}return c},_getLetterPosXLeft:function(a){return a.getPositionX()*this._scaleX-a._getWidth()*this._scaleX*a._getAnchorX()},_getLetterPosXRight:function(a){return a.getPositionX()*this._scaleX+a._getWidth()*this._scaleX*a._getAnchorX()}});_p=cc.LabelBMFont.prototype;cc.defineGetterSetter(_p,"opacityModifyRGB",_p.isOpacityModifyRGB,_p.setOpacityModifyRGB);cc.defineGetterSetter(_p,"opacity",_p.getOpacity,_p.setOpacity);
cc.defineGetterSetter(_p,"cascadeOpacity",_p.isCascadeOpacityEnabled,_p.setCascadeOpacityEnabled);cc.defineGetterSetter(_p,"color",_p.getColor,_p.setColor);cc.defineGetterSetter(_p,"cascadeColor",_p.isCascadeColorEnabled,_p.setCascadeColorEnabled);cc.defineGetterSetter(_p,"string",_p.getString,_p._setStringForSetter);cc.defineGetterSetter(_p,"boundingWidth",_p._getBoundingWidth,_p.setBoundingWidth);cc.defineGetterSetter(_p,"textAlign",_p._getAlignment,_p.setAlignment);
cc.LabelBMFont.create=function(a,b,c,d,e){return new cc.LabelBMFont(a,b,c,d,e)};cc.isspace_unicode=function(a){a=a.charCodeAt(0);return 9<=a&&13>=a||32==a||133==a||160==a||5760==a||8192<=a&&8202>=a||8232==a||8233==a||8239==a||8287==a||12288==a};cc.utf8_trim_ws=function(a){var b=a.length;if(!(0>=b)&&(b-=1,cc.isspace_unicode(a[b]))){for(var c=b-1;0<=c;--c)if(cc.isspace_unicode(a[c]))b=c;else break;cc.utf8_trim_from(a,b)}};cc.utf8_trim_from=function(a,b){var c=a.length;b>=c||0>b||a.splice(b,c)};
...
this._children;if(m&&0<m.length)for(b=0,k=m.length;b<k;b++)d>=a.length||!(g=a[d])||(h=m[b].height,e=e>=h||isNaN(h)?e:h,++f,f>=g&&(c+=e+5,e=f=0,++d));var q=cc.director.getWinSize(),n=g=e=d=0,r=0,c=c/2;if(m&&0<m.length)for(b=0,k=m.length;b<k;b++){var s=m[b];0==g&&(g=a[d],r=n=q.width/(1+g));h=s._getHeight();e=e>=h||isNaN(h)?e:h;s.setPosition(r-q.width/2,c-h/2);r+=n;++f;f>=g&&(c-=e+5,e=g=f=0,++d)}},alignItemsInRows:function(){0<arguments.length&&null==arguments[arguments.length-1]&&cc.log("parameters should not be ending with null in Javascript");
var a=[],b;for(b=0;b<arguments.length;b++)a.push(arguments[b]);var c=[],d=[],e=-10,f=-5,g=0,h=0,k=0,m,q,n,r,s=this._children;if(s&&0<s.length)for(b=0,n=s.length;b<n;b++)(q=s[b],g>=a.length||!(m=a[g]))||(r=q.width,h=h>=r||isNaN(r)?h:r,f+=q.height+5,++k,k>=m&&(c.push(h),d.push(f),e+=h+10,h=k=0,f=-5,++g));f=cc.director.getWinSize();m=h=g=0;var e=-e/2,t=0;if(s&&0<s.length)for(b=0,n=s.length;b<n;b++)q=s[b],0==m&&(m=a[g],t=d[g]),r=q._getWidth(),h=h>=r||isNaN(r)?h:r,q.setPosition(e+c[g]/2,t-f.height/2),
t-=q.height+10,++k,k>=m&&(e+=h+5,h=m=k=0,++g)},removeChild:function(a,b){null!=a&&(a instanceof cc.MenuItem?(this._selectedItem==a&&(this._selectedItem=null),cc.Node.prototype.removeChild.call(this,a,b)):cc.log("cc.Menu.removeChild():Menu only supports MenuItem objects as children"))},_onTouchBegan:function(a,b){var c=b.getCurrentTarget();if(c._state!=cc.MENU_STATE_WAITING||!c._visible||!c.enabled)return!1;for(var d=c.parent;null!=d;d=d.parent)if(!d.isVisible())return!1;c._selectedItem=c._itemForTouch(a);
...
a&&a();b&&b();0!=this._loadState&&"autoplay"!=this.autoplay&&!0!=this.autoplay||this._play();this._loadState=1},_onError:function(){var a=this._events.error;a&&a();this._loadState=-2},cloneNode:function(){var a=new cc.WebAudio(this.src);a.volume=this.volume;a._loadState=this._loadState;a._buffer=this._buffer;0!=a._loadState&&-1!=a._loadState||a.load();return a}});_p=cc.WebAudio.prototype;cc.defineGetterSetter(_p,"loop",function(){return this._loop},function(a){this._loop=a;this._sourceNode&&(this._sourceNode.loop=
a)});cc.defineGetterSetter(_p,"volume",function(){return this._volume},function(a){this._volume=a;this._volumeNode.gain.value=a});cc.defineGetterSetter(_p,"paused",function(){return this._paused});cc.defineGetterSetter(_p,"ended",function(){var a=this._sourceNode;return!this._paused&&(this._stopped||!a||3==a.playbackState)});cc.defineGetterSetter(_p,"played",function(){var a=this._sourceNode;return a&&2==a.playbackState})}
...
cc._audioLoader={_supportedAudioTypes:null,getBasePath:function(){return cc.loader.audioPath},_load:function(a,b,c,d,e,f,g){var h=this,k=cc.loader,m=cc.path,q=this._supportedAudioTypes,n="";if(0==q.length)return g("can not support audio!");if(-1==d)n=(m.extname(a)||"").toLowerCase(),h.audioTypeSupported(n)||(n=q[0],d=0);else if(d<q.length)n=q[d];else return g("can not found the resource of audio! Last match url is : "+a);if(0<=e.indexOf(n))return h._load(a,b,c,d+1,e,f,g);a=m.changeExtname(a,n);e.push(n);
f=h._loadAudio(a,f,function(k){if(k)return h._load(a,b,c,d+1,e,f,g);g(null,f)},d==q.length-1);k.cache[b]=f},audioTypeSupported:function(a){return a?0<=this._supportedAudioTypes.indexOf(a.toLowerCase()):!1},_loadAudio:function(a,b,c,d){var e="file://"==location.origin?Audio:cc.WebAudio||Audio;2==arguments.length?(c=b,b=new e):3<arguments.length&&!b&&(b=new e);b.src=a;b.preload="auto";e=navigator.userAgent;/Mobile/.test(e)&&(/iPhone OS/.test(e)||/iPad/.test(e)||/Firefox/.test(e))||/MSIE/.test(e)?(b.load(),
...
cc.audioEngine=cc.AudioEngineForSingle?new cc.AudioEngineForSingle:new cc.AudioEngine;cc.eventManager.addCustomListener(cc.game.EVENT_HIDE,function(){cc.audioEngine._pausePlaying()});cc.eventManager.addCustomListener(cc.game.EVENT_SHOW,function(){cc.audioEngine._resumePlaying()});var res={mapbg1:"res/images/map_bg0.png",roleimg:"res/images/role_big0.png",startmenu:"res/images/menu0.png",startmenuplist:"res/plist/menu0.plist",startui:"res/images/ui0.png",startuiplist:"res/plist/ui0.plist",petnum:"res/images/pet_num.png",bullet_lv:"res/images/bullet_lv.png",bullet_lv_plist:"res/plist/bullet_lv.plist",cj_plist:"res/plist/cj.plist",cjimg:"res/images/cj.png",spimg:"res/images/sp_all.png",spplist:"res/plist/sp_all.plist",font_m:"res/images/game_m.png",num_ji:"res/images/num_x0.png",
num_ji0:"res/images/num_jl0.png",daojuimg:"res/images/add_image.png",daoju_plist:"res/plist/add_image.plist",pauseimg:"res/images/pause_all.png",pause_plist:"res/plist/pause_all.plist",effectimg:"res/images/effect0.png",effectplist:"res/plist/effect0.plist",effect2img:"res/images/cc_efx.png",effect2plist:"res/plist/cc_efx.plist",cjuiimg:"res/images/ui_ts.png",cjuiplist:"res/plist/ui_ts.plist"},start_resources=[res.mapbg1,res.roleimg,res.startmenu,res.startmenuplist,res.startui,res.startuiplist,res.petnum,
res.num_ji,res.num_ji0,res.font_m],shop_resources=[res.bullet_lv,res.bullet_lv_plist],cj_resources=[res.cj_plist,res.cjimg],game_resources=[res.bullet_lv_plist,res.bullet_lv,res.spplist,res.spimg,res.daoju_plist,res.daojuimg,res.pause_plist,res.pauseimg,res.effectplist,res.effectimg,res.effect2plist,res.effect2img],gameover_resources=[res.cjuiplist,res.cjuiimg],g_resources=[res.mapbg1,res.roleimg,res.startmenu,res.startui,res.petnum,res.bullet_lv,res.cjimg,res.spimg,res.num_ji,res.num_ji0,res.font_m,
res.daojuimg,res.pauseimg,res.effectimg,res.effect2img,res.cjuiimg,res.startmenuplist,res.startuiplist,res.bullet_lv_plist,res.cj_plist,res.spplist,res.daoju_plist,res.pause_plist,res.effectplist,res.effect2plist,res.cjuiplist];var LoadUtil=function(){this.init()};
LoadUtil.prototype={hasLoad:[],scene_resouceMap:{},init:function(){var a=this.scene_resouceMap;a.GameStartScene="start_resources";a.GameShopScene="shop_resources";a.GameZbScene="shop_resources";a.GameCjScene="cj_resources";a.GameScene="game_resources";a.GameOverScene="gameover_resources"},loadSceneByName:function(a,b){if(window[a]){if(!this.checkHasLoad(a)){var c=this.scene_resouceMap[a];if(c){var d=this;LoaderScene.preload(window[c],function(){cc.director.runScene(new window[a](b));d.hasLoad.push(c)});
return}}cc.director.runScene(new window[a](b))}},checkHasLoad:function(a){for(var b=this.scene_resouceMap,c=0;c<this.hasLoad.length;c++)if(b[a]==this.hasLoad[c])return!0;return!1}};LoadUtil.getInstance=function(){this.instance||(this.instance=new LoadUtil);return this.instance};var LocalUtil=function(){this.init()};
LocalUtil.prototype={LOCAL_DATABASE_KEY:"FEIJI_KOUDAIWAN",CJ_DATABASE_KEY:"CJ_FEIJI_KOUDAIWAN",localData:null,cjData:null,init:function(){var a=window.localStorage.getItem(this.LOCAL_DATABASE_KEY);null==a&&(a=cc.loader._loadTxtSync("res/config/localInit.txt"),window.localStorage.setItem(this.LOCAL_DATABASE_KEY,a));this.localData=JSON.parse(a);a=window.localStorage.getItem(this.CJ_DATABASE_KEY);null==a&&(a=cc.loader._loadTxtSync("res/config/cjInit.txt"),window.localStorage.setItem(this.CJ_DATABASE_KEY,a));
this.cjData=JSON.parse(a)},getNumByKey:function(a){return this.localData[a]},getPlaneIndex:function(){return this.localData.selectplane},selectPlaneByIndex:function(a){this.localData.selectplane=a;this.save()},getPlaneLv:function(a){return this.localData.planeconfig[a].lv},getMoney:function(){return this.getNumByKey("gold")},setNumByKey:function(a,b){this.localData[a]=b},setMoney:function(a){this.setNumByKey("gold",a)},setPlaneLv:function(a,b){this.localData.planeconfig[a].lv=b},save:function(){var a=
JSON.stringify(this.localData);window.localStorage.setItem(this.LOCAL_DATABASE_KEY,a)},saveCj:function(){var a=JSON.stringify(this.cjData);window.localStorage.setItem(this.CJ_DATABASE_KEY,a)},getJyMsg:function(){return this.cjData.jytz},getJqMsg:function(){return this.cjData.jqtz},addNumByKeyAndSave:function(a,b){this.addNumByKey(a,b);this.save()},addNumByKey:function(a,b){var c=this.getNumByKey(a)+b;0>c&&(c=0);this.setNumByKey(a,c)},checkCj:function(){for(var a=this.getJyMsg(),b=!1,c=0;c<a.length;c++){var d=
a[c];if(0==d.hasGet){var e=this.checkjyCjByZige(d.zige);e&&(d.hasGet=1,b=!0)}}a=this.getJqMsg();for(c=0;c<a.length;c++)if(d=a[c],0==d.hasGet&&(e=this.checkjqCjByZige(d.zige)))d.hasGet=1,b=!0;b&&this.saveCj();return b},checkjyCjByZige:function(a){var b=a.value,c=0;switch(a.leibie){case "dis":c=this.getNumByKey("totalDistanse");break;case "diji":c=this.getNumByKey("totalKillNum");break;case "gold":c=this.getNumByKey("totalGoldNum");break;case "daoju":c=this.getNumByKey("totalUseDaoju");break;case "die":c=
this.getNumByKey("totalDead")}return c>=b?!0:!1},checkjqCjByZige:function(a){var b=a.value,c=0;switch(a.leibie){case "dis":c=this.getNumByKey("maxDistanse");break;case "chongci":c=this.getNumByKey("onceBestChongCi");break;case "chongcizhixing":c=this.getNumByKey("onceBestChongCiDaoJu");break;case "score":c=this.getNumByKey("bestScore")}return c>=b?!0:!1},changeHasGetByIndexAndCjstate:function(a,b){var c;c=1==b?this.getJyMsg():this.getJqMsg();cc.log("index:"+a);cc.log("cjstate:"+b);c[a].hasGet=2;this.saveCj()}};
LocalUtil.getInstance=function(){this.instance||(this.instance=new LocalUtil);return this.instance};var SelectItemConfig=function(){this.init()};
SelectItemConfig.prototype={config:{wqgz:{desTitle:"\u6b66\u5668\u6539\u9020",des:"\u5347\u7ea7\u4f60\u7684\u57fa\u7840\u6b66\u5668\uff0c\u663e\u8457\u63d0\u9ad8\u706b\u529b",buyMoney:"auto",res:"auto"},jgnl:{desTitle:"\u6fc0\u5149\u80fd\u91cf",des:"\u7206\u53d1\u80fd\u91cf\u6da1\u8f6e\uff0c\u968f\u65f6\u8fdb\u5165\u9ad8\u901f\u51b2\u51fb\u72b6\u6001\u524d\u8fdb1000\u7c73\uff0c\u643a\u5e26\u4e0a\u9650\u4e3a3",buyMoney:800,res:"shop_icon0.png"},m1500:{desTitle:"\u6da1\u8f6e\u5f62\u6001",des:"\u6e38\u620f\u542f\u52a8\u65f6\u4f7f\u6218\u673a\u8fdb\u5165\u9ad8\u901f\u51b2\u51fb\u72b6\u6001\uff0c\u4ee5\u80fd\u91cf\u76fe\u7b3c\u7f69\u5411\u524d\u51b2\u523a1500\u7c73",
buyMoney:300,res:"shop_icon1.png"},m3000:{desTitle:"\u8d85\u7ea7\u6da1\u8f6e\u5f62\u6001",des:"\u6e38\u620f\u542f\u52a8\u65f6\u4f7f\u6218\u673a\u8fdb\u5165\u9ad8\u901f\u51b2\u51fb\u72b6\u6001\uff0c\u4ee5\u80fd\u91cf\u76fe\u7b3c\u7f69\u5411\u524d\u51b2\u523a3000\u7c73",buyMoney:600,res:"shop_icon2.png"},zjhd:{desTitle:"\u7ec8\u6781\u6838\u5f39",des:"\u6050\u6016\u7684\u5a01\u529b\u8ba9\u654c\u519b\u95fb\u98ce\u4e27\u80c6\uff0c\u53ef\u4ee5\u6e05\u9664\u5168\u5c4f\u654c\u673a\uff0c\u643a\u5e26\u4e0a\u9650\u4e3a3",
buyMoney:500,res:"shop_icon3.png"},tszy:{desTitle:"\u5929\u4f7f\u4e4b\u7ffc",des:"\u6218\u673a\u53d7\u635f\u540e\uff0c\u9a6c\u4e0a\u4f7f\u7528\u53e6\u4e00\u8258\u6218\u673a\u7ee7\u7eed\u6218\u6597\uff01",buyMoney:1E3,res:"shop_icon4.png"},zbpj:{res:"shop_icon5.png",linkLayer:"GameZbScene"},cqpj:{desTitle:"\u62bd\u53d6\u914d\u4ef6",des:"\u65b0\u7684\u6280\u672f\u4f7f\u6211\u4eec\u7684\u6218\u6597\u673a\u53ef\u4ee5\u643a\u5e26\u4e24\u4e2a\u5f3a\u5927\u7684\u50da\u673a\u8f85\u52a9\u653b\u51fb\uff0c\u5f53\u7136\u5176\u9020\u4ef7\u4e5f\u5341\u5206\u9ad8\u6602",
buyMoney:2E3,res:"shop_icon6.png"},pjyx:{desTitle:"\u914d\u4ef6\u6cb9\u7bb1",des:"\u6d88\u8017\u54c1\uff0c\u6bcf\u6b21\u5728\u4f5c\u6218\u4e2d\u63d0\u9ad8\u914d\u4ef6\u7684\u5347\u7ea7\u7ecf\u9a8c",buyMoney:600,res:"shop_icon7.png"},sscc:{desTitle:"\u6b7b\u795e\u51b2\u523a",des:"\u98de\u884c\u7ed3\u675f\u540e\uff0c\u4f60\u4ecd\u7136\u53ef\u4ee5\u5229\u7528\u9ad8\u6821\u6da1\u65cb\u7cfb\u7edf\u8fdb\u884c\u4e00\u6b21\u6700\u540e\u51b2\u523a\uff0c\u8fbe\u5230\u65b0\u9ad8\u5ea6",buyMoney:200,res:"shop_icon8.png"},
qhzj:{res:"shop_icon9.png",linkLayer:"GameSelectPlaneScene"}},init:function(){},getConfig:function(){return this.config}};SelectItemConfig.getInstance=function(){this.instance||(this.instance=new SelectItemConfig);return this.instance};var EnemyFactory=function(){this.init()};
EnemyFactory.prototype={SAN_JIAO_ZHEN:0,YI_ZI_CHANG_SHE_ZHEN:1,YI_ZI_CHANG_SHE_DAO_ZHEN:2,planeBlood:[600,1800,4800,9600,10800,16800,23800,35E3,3E3],zhenxing:[],init:function(){this.initZhenXing()},initZhenXing:function(){this.zhenxing[this.SAN_JIAO_ZHEN]=[480,460,440,460,480];this.zhenxing[this.YI_ZI_CHANG_SHE_DAO_ZHEN]=[500,490,480,470,460];this.zhenxing[this.YI_ZI_CHANG_SHE_ZHEN]=[460,470,480,490,500]},getPlanesMsgByDis:function(a){var b=[],c=-1;Math.floor(3*Math.random())&&(c=Math.floor(5*Math.random()));
a=parseInt(a/250);7<a&&(a=7);for(var d=0;5>d;d++)d==c?b[d]=8:(b[d]=a-Math.floor(2*Math.random()),0>b[d]&&(b[d]=0));return b},createEnemyByZhenXingAndDis:function(a,b,c){b=this.getPlanesMsgByDis(b);a=this.zhenxing[a];for(var d=[],e=0;5>e;e++){var f=EnemySprite.createWithResAndBlood(b[e],this.planeBlood[b[e]],c),g=32+64*e;f.setPosition(cc.p(g,a[e]));f.moveTo(cc.p(g,-30));d.push(f)}return d}};EnemyFactory.getInstance=function(){this.instance||(this.instance=new EnemyFactory);return this.instance};var BaoshiFactory=function(){};
BaoshiFactory.prototype={createBaoshiByGold:function(a,b){var c,d,e;e=parseInt(a/20);d=parseInt((a-20*e)/10);c=a-20*e-10*d;for(var f=[],g=0;g<e;g++){var h=cc.Sprite.create("#item_green.png");h.setUserData([20]);h.setPosition(b);f.push(h)}for(g=0;g<d;g++)e=cc.Sprite.create("#item_red.png"),e.setUserData([10]),e.setPosition(b),f.push(e);for(g=0;g<c;g++)d=cc.Sprite.create("#item_coin.png"),d.setUserData([1]),d.setPosition(b),f.push(d);this.giveAction(f);return f},createDaojuBaoshiByIndex:function(a,b){var c;
switch(a){case 0:c="#item_cc.png";break;case 1:c="#item_double.png";break;case 2:c="#item_down_skill.png";break;case 3:c="#item_up_skill.png";break;case 4:c="#item_xts.png"}c=cc.Sprite.create(c);c.setUserData([a]);c.setPosition(b);this.giveAction([c]);return c},giveAction:function(a){for(var b=0;b<a.length;b++){var c=a[b],d=c.getPosition().x-32+Math.floor(60*Math.random()),e=cc.p(d,-30),d=cc.JumpTo.create(1.5,e,200,1),f=c.getUserData();f&&(f[1]=e);e=cc.CallFunc.create(function(a){return function(){a.removeFromParent()}}(c));
d=cc.Sequence.create([d,e]);c.runAction(d)}},changeAction:function(a,b){a.stopAllActions();var c=cc.MoveTo.create(0.1,b),d=cc.CallFunc.create(function(){a.removeFromParent()}),c=cc.Sequence.create([c,d]);a.getUserData()[1]=b;a.runAction(c)}};BaoshiFactory.getInstance=function(){this.instance||(this.instance=new BaoshiFactory);return this.instance};var LuoshiFactory=function(){};LuoshiFactory.prototype={createSingleLuoshi:function(a,b){var c=new LuoshiSprite;c.setPosition(cc.p(a.x,480));b.addChild(c);this.startLuoshiAction(c)},createSingleJingJie:function(a,b,c,d){var e=new JingJieSprite(c);e.setPosition(a);b.addChild(e);d&&e.schedule(function(){d(e)},1,2,1)},startLuoshiAction:function(a){var b=a.getPosition(),b=cc.MoveTo.create(1,cc.p(b.x,-20)),c=cc.CallFunc.create(function(){a.removeFromParent()}),b=cc.Sequence.create([b,c]);a.runAction(b)}};
LuoshiFactory.getInstance=function(){this.instance||(this.instance=new LuoshiFactory);return this.instance};var BgMoveLayer=cc.Layer.extend({batchSprite:null,bgres:null,speed:2,fps:60,init:function(){return this._super()?(this.initBatchNode(),this.initBg(),this.initSchedule(),!0):!1},initWithBgAndSpeed:function(a,b,c){this.speed=b;this.bgres=a;this.fps=c||this.fps;this.init()},initBatchNode:function(){this.batchSprite=cc.SpriteBatchNode.create(this.bgres||res.mapbg1);this.addChild(this.batchSprite,1);this.batchSprite.setPosition(0,0)},initBg:function(){for(var a=0;2>a;a++){var b=cc.Sprite.create(res.mapbg1),
c=b.getTextureRect().height;b.setAnchorPoint(0,0);b.setBatchNode(this.batchSprite);b.setPosition(cc.p(0,a*c));this.batchSprite.addChild(b)}},initSchedule:function(){this.schedule(this.move,1/this.fps)},move:function(){for(var a=this.batchSprite.getChildren(),b=a.length,c=0;c<b;c++){var d=a[c],e=d.getPosition(),f=d.getTextureRect().height;d.setPosition(cc.p(0,0>=e.y+f?e.y+f*b-this.speed:e.y-this.speed))}},onExit:function(){this._super();this.unscheduleAllCallbacks()},changeSpeed:function(a){this.speed=
a}});BgMoveLayer.createWithBgAndSpeed=function(a,b,c){var d=new BgMoveLayer;d.initWithBgAndSpeed(a,b,c);return d};var PlaneSelectItemSprite=cc.Sprite.extend({nomalLayer:null,bgRess:["sel_role_k1.png","sel_role_k0.png"],planeRess:["ui_role_head0.png","ui_role_head1.png","ui_role_head2.png"],infoRess:["ui_role_info0.png","ui_role_info1.png","ui_role_info2.png"],bgRes:null,planeRes:null,infoRes:null,isSelect:!1,bgSprite:null,listenner:null,target:null,touchable:!0,ctor:function(a,b){this._super();this.bgRes=(this.isSelect=a)?"#"+this.bgRess[1]:"#"+this.bgRess[0];this.planeRes="#"+this.planeRess[b];this.infoRes=
"#"+this.infoRess[b];this.setUserData(b)},init:function(){this._super();cc.spriteFrameCache.addSpriteFrames(res.startuiplist,res.startui);this.initLayer();this.initItem();this.initListenner()},initLayer:function(){this.nomalLayer=cc.Layer.create();this.addChild(this.nomalLayer)},initItem:function(){this.bgSprite=cc.Sprite.create(this.bgRes);this.nomalLayer.addChild(this.bgSprite);var a=cc.Sprite.create(this.planeRes);a.setPosition(cc.p(-80,0));this.nomalLayer.addChild(a);a=cc.Sprite.create(this.infoRes);
a.setPosition(50,0);this.nomalLayer.addChild(a)},select:function(){var a=cc.spriteFrameCache.getSpriteFrame(this.bgRess[1]);this.bgSprite.setSpriteFrame(a);this.isSelect=!0},unSelect:function(){var a=cc.spriteFrameCache.getSpriteFrame(this.bgRess[0]);this.bgSprite.setSpriteFrame(a);this.isSelect=!1},initListenner:function(){cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:this.onTouchBegan,onTouchMoved:null,onTouchEnded:null},this)},clickSelf:function(){this.listenner&&
this.listenner.call(this.target,this)},addOnClickListenner:function(a,b){this.listenner=a;this.target=b},onTouchBegan:function(a,b){var c=b.getCurrentTarget();if(c.touchable){var d=a.getLocation(),e=c.getPosition(),f=e.x+150,g=e.y-72,h=e.y+72;if(d.x>e.x-150&&d.x<f&&d.y>g&&d.y<h)return c.clickSelf(),!0}},setTouchEnabled:function(a){this.touchable=a}});PlaneSelectItemSprite.createWithSelectAndPlaneindex=function(a,b){var c=new PlaneSelectItemSprite(a,b);c.init();return c};var NumSprite=cc.Sprite.extend({numFrames:null,widthOne:0,init:function(){this._super()},initNumFrames:function(a){this.numFrames=[];for(var b=cc.Sprite.create(a).getTextureRect(),c=b.height,b=this.widthOne=b.width/10,d=0;10>d;d++){var e=cc.SpriteFrame.create(a,new cc.Rect(d*b,0,b,c));this.numFrames.push(e)}},initWithNum:function(a,b){this.init();this.initNumFrames(b);this.updateByNum(a)},updateByNum:function(a){this.removeAllChildren();a=this.getNums(a);for(var b=a.length,c=-this.widthOne/2*(b-1),
d=0;d<b;d++){var e=cc.Sprite.create(this.numFrames[a[d]]);e.setPosition(cc.p(c+d*this.widthOne,0));this.addChild(e)}},updateByNums:function(a,b){this.removeAllChildren();var c=this.getNums(a),d=this.getNums(b),e=-this.widthOne/2*(c.length+d.length+1-1),f;for(f=0;f<c.length;f++){var g=c[f],g=cc.Sprite.create(this.numFrames[g]);g.setPosition(cc.p(e+f*this.widthOne,0));this.addChild(g)}c=cc.Sprite.create(this.numFrames[10]);c.setPosition(cc.p(e+f++*this.widthOne,0));this.addChild(c);for(c=0;c<d.length;c++)g=
d[c],g=cc.Sprite.create(this.numFrames[g]),g.setPosition(cc.p(e+(c+f)*this.widthOne,0)),this.addChild(g)},getNums:function(a){var b=[];a+="";for(var c=0;c<a.length;c++){var d=a.charAt(c);b.push(parseInt(d))}return b}});NumSprite.createWithNumAndFile=function(a,b){var c=new NumSprite;c.initWithNum(a,b);return c};var ItemDesSprite=cc.Sprite.extend({nomalLayer:null,money:null,titleLabel:null,desLabel:null,numSprite:null,init:function(){this._super();this.nomalLayer=cc.Layer.create();this.addChild(this.nomalLayer);this.initBg();this.initFont();this.initMoney()},initWithTitleDesAndMoney:function(a,b,c){this.money=c;this.init();this.titleLabel.setString(a);this.desLabel.setString(b)},initBg:function(){var a=cc.Sprite.create("#shop_k1.png");this.nomalLayer.addChild(a)},initFont:function(){this.titleLabel=cc.LabelTTF.create("\u6b66\u5668\u6539\u9020",
"Arial",15);this.desLabel=cc.LabelTTF.create("\u5347\u7ea7\u4f60\u7684\u57fa\u7840\u6b66\u5668\uff0c\u663e\u8457\u63d0\u5347\u706b\u529b","Arial",14,cc.size(220,60));this.titleLabel.setPosition(cc.p(-120,30));this.desLabel.setPosition(cc.p(-140,13));this.titleLabel.setAnchorPoint(0,0.5);this.desLabel.setAnchorPoint(0,1);this.nomalLayer.addChild(this.titleLabel);this.nomalLayer.addChild(this.desLabel)},initMoney:function(){var a=cc.Sprite.create("#gold_icon_x.png");a.setPosition(cc.p(70,30));this.nomalLayer.addChild(a);
this.money=this.money||0;this.numSprite=NumSprite.createWithNumAndFile(this.money,res.petnum);this.numSprite.setPosition(cc.p(110,30));this.nomalLayer.addChild(this.numSprite)},setTitleAndDesAndMoney:function(a,b,c){this.titleLabel.setString(a);this.desLabel.setString(b);this.money=c;this.numSprite.updateByNum(c)},setMoney:function(a){this.money=a;this.numSprite.updateByNum(a)}});ItemDesSprite.createWithTitleDesAndMoney=function(a,b,c){var d=new ItemDesSprite;d.initWithTitleDesAndMoney(a,b,c);return d};var SelectItemSprite=cc.Sprite.extend({nomalLayer:null,frontRes:null,hasNum:null,lv:null,numSprite:null,frontSprite:null,bgFrames:[],isSelect:!1,bgSprite:null,listenner:null,target:null,touchable:!0,init:function(){this._super();this.initLayer();this.initBg();this.initFront();this.initNum();this.initLv();this.initListenner()},initWithRes:function(a,b,c){this.hasNum=b;this.frontRes=a;this.isSelect=c;this.init()},initBulletWithRes:function(a,b,c){this.lv=b;this.frontRes=a;this.isSelect=c;this.init()},
initLayer:function(){this.nomalLayer=cc.Layer.create();this.addChild(this.nomalLayer);this.nomalLayer},initBg:function(){var a;a=cc.spriteFrameCache.getSpriteFrame("shop_k0.png");var b=cc.spriteFrameCache.getSpriteFrame("shop_sel_k.png");this.bgFrames.push(a);this.bgFrames.push(b);this.bgSprite=a=this.isSelect?cc.Sprite.create(b):cc.Sprite.create(a);this.nomalLayer.addChild(a)},initFront:function(){this.frontRes=this.frontRes||"#shop_icon0.png";var a=this.frontSprite=cc.Sprite.create(this.frontRes);
this.nomalLayer.addChild(a)},initNum:function(){"undefined"!=typeof this.hasNum&&null!=this.hasNum&&(this.numSprite=NumSprite.createWithNumAndFile(this.hasNum,res.petnum),this.numSprite.setPosition(cc.p(25,25)),this.nomalLayer.addChild(this.numSprite))},initLv:function(){if("undefined"!=typeof this.lv&&null!=this.lv){this.numSprite=NumSprite.createWithNumAndFile(this.lv,res.petnum);this.numSprite.setPosition(cc.p(9,-15));var a=cc.Sprite.create("#role_bullet_lv2.png");a.setPosition(cc.p(-9,-15));a.setScale(0.7);
this.nomalLayer.addChild(a);this.nomalLayer.addChild(this.numSprite)}},setNum:function(a){this.hasNum=a;this.numSprite.updateByNum(a)},setLv:function(a,b){this.lv=b;this.numSprite.updateByNum(b);var c=cc.spriteFrameCache.getSpriteFrame(a+1+"_"+b+".png");this.frontSprite.setSpriteFrame(c)},setSelect:function(a){this.isSelect!=a&&(this.isSelect=a,a=0,this.isSelect&&(a=1),this.bgSprite.setSpriteFrame(this.bgFrames[a]))},addOnClickListenner:function(a,b){this.listenner=a;this.target=b},clickSelf:function(){this.listenner&&
this.listenner.call(this.target,this)},initListenner:function(){cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:this.onTouchBegan,onTouchMoved:null,onTouchEnded:null},this)},onTouchBegan:function(a,b){var c=b.getCurrentTarget();if(c.touchable){var d=a.getLocation(),e=c.getPosition(),f=e.x+40,g=e.y-40,h=e.y+40;if(d.x>e.x-40&&d.x<f&&d.y>g&&d.y<h)return c.clickSelf(),!0}},setTouchEnabled:function(a){this.touchable=a}});
SelectItemSprite.createWithFile=function(a,b,c){var d=new SelectItemSprite;d.initWithRes(a,b,c);return d};SelectItemSprite.createBulletWithFile=function(a,b,c){var d=new SelectItemSprite;d.initBulletWithRes(a,b,c);return d};var MsgListViewItem=cc.Sprite.extend({title:null,msg:null,titleLabel:null,msgSprite:null,nomalLayer:null,init:function(){return this._super()?(this.initLayer(),this.initLabel(),this.initNumSprite(),!0):!1},initWithMsg:function(a,b){this.title=a;this.msg=b;this.init()},initLayer:function(){this.nomalLayer=cc.Layer.create();this.addChild(this.nomalLayer)},initLabel:function(){this.titleLabel=cc.LabelTTF.create(this.title,"Arial",15);this.titleLabel.setAnchorPoint(0,0.5);this.titleLabel.setPosition(cc.p(-130,
0));this.nomalLayer.addChild(this.titleLabel)},initNumSprite:function(){var a=NumSprite.createWithNumAndFile(this.msg,res.petnum);this.msgSprite=a;a.setPosition(cc.p(90,0));this.nomalLayer.addChild(a)}});MsgListViewItem.createWithMsg=function(a,b){var c=new MsgListViewItem;c.initWithMsg(a,b);return c};var CjListViewItem=cc.Sprite.extend({title:null,msg:null,index:null,titleLabel:null,msgSprite:null,nomalLayer:null,lis:null,tar:null,init:function(){return this._super()?(this.initLayer(),this.initLabel(),this.initButton(),!0):!1},initWithMsg:function(a,b,c){this.title=a;this.msg=b;this.index=c;this.init()},initLayer:function(){this.nomalLayer=cc.Layer.create();this.addChild(this.nomalLayer)},initLabel:function(){this.titleLabel=cc.LabelTTF.create(this.title,"Arial",15);this.titleLabel.setAnchorPoint(0,
0.5);this.titleLabel.setPosition(cc.p(-130,0));this.nomalLayer.addChild(this.titleLabel)},initButton:function(){var a;cc.log("hasget:"+this.msg);switch(this.msg){case 0:a="#cj_jl0_x.png";break;case 1:a="#cj_jl0.png";break;case 2:a="#cj_jl1.png"}this.msgSprite=cc.Sprite.create(a);a=cc.MenuItemSprite.create(this.msgSprite,null,null,this.click,this);a.setPosition(cc.p(-60,-240));a=cc.Menu.create([a]);this.nomalLayer.addChild(a)},click:function(){this.lis&&this.lis.call(this.tar,this.index)},setOnClickListener:function(a,
b){this.lis=a;this.tar=b},changeBtnAndRemoveLis:function(){this.msg=2;this.lis=null;var a=cc.spriteFrameCache.getSpriteFrame("cj_jl1.png");this.msgSprite.setSpriteFrame(a)},chageMsg:function(){}});CjListViewItem.createWithMsg=function(a,b,c){var d=new CjListViewItem;d.initWithMsg(a,b,c);return d};var HeroSprite=cc.Sprite.extend({hasUse:[],hero:null,fireSprite:null,touchBeginPos:null,touchMovePos:null,currentContentLayerPos:null,touchable:!0,nomalLayer:null,deadLayer:null,xtsEffectSprite:null,ccEffectSprite:null,_isShuangBeiFire:!1,_isXTSEffect:!1,_isccEffect:!1,_isDead:!1,moveLis:null,init:function(){return this._super()?(this.initLayer(),this.initHero(),this.initFire(),this.initListenner(),this.initPeijian(),this.initXtsEffect(),!0):!1},initLayer:function(){this.nomalLayer=cc.Layer.create();
this.addChild(this.nomalLayer);this.deadLayer=cc.Layer.create();this.addChild(this.deadLayer)},initHero:function(){var a=LocalUtil.getInstance().getPlaneIndex();this.hasUse.push(a);this.hero=cc.Sprite.create("#role"+a+".png");this.nomalLayer.addChild(this.hero,1)},initFire:function(){var a=this.fireSprite=cc.Sprite.create("#role_fire0.png");a.setPosition(cc.p(0,-70));this.nomalLayer.addChild(a,1);for(var b=[],c=0;4>c;c++){var d=cc.spriteFrameCache.getSpriteFrame("role_fire"+c+".png");b.push(d)}b=
cc.Animation.create(b,0.1);b=cc.Animate.create(b);b=cc.RepeatForever.create(b);a.runAction(b)},initXtsEffect:function(){this.xtsEffectSprite=cc.Sprite.create("#x_t_s.png");this.xtsEffectSprite.setVisible(!1);this.nomalLayer.addChild(this.xtsEffectSprite)},setOnMoveListenner:function(a){this.moveLis=a},addCcEffect:function(){if(!this._isccEffect){var a=new CCEffectStartSprite;this.ccEffectSprite=new CCEffectSprite;var b=this;setTimeout(function(){b.nomalLayer.addChild(b.ccEffectSprite)},600);this.nomalLayer.addChild(a,
1);this._isccEffect=!0}},removeCcEffect:function(){this._isccEffect&&this.ccEffectSprite&&(this.ccEffectSprite.removeFromParent(),this.ccEffectSprite=null,this._isccEffect=!1)},initListenner:function(){cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:this.onTouchBegan,onTouchMoved:this.onTouchMoved,onTouchEnded:this.onTouchEnded},this)},runXtsAction:function(){var a=cc.ScaleTo.create(0.3,0.3),b=this,c=cc.CallFunc.create(function(){b.xtsEffectSprite.setScale(1)}),
a=cc.Sequence.create([a,c]),a=cc.RepeatForever.create(a);this.xtsEffectSprite.runAction(a)},stopXtsAction:function(){this.xtsEffectSprite.stopAllActions()},isContainPoint:function(a,b,c){var d=29,e=33;b&&this._isXTSEffect&&(d*=6,e*=6);c&&(d+=c,e+=c);b=this.getPosition();c=b.x+d;var f=b.y-e,e=b.y+e;return a.x>b.x-d&&a.x<c&&a.y>f&&a.y<e?!0:!1},onTouchBegan:function(a,b){var c=b.getCurrentTarget();if(c.touchable){var d=a.getLocation();return c.isContainPoint(d)?(c.touchBeginPos=a.getLocation(),c.currentContentLayerPos=
c.getPosition(),!0):!1}},onTouchMoved:function(a,b){var c=b.getCurrentTarget();if(c.touchable){var d=a.getLocation(),e=d.y-c.touchBeginPos.y+c.currentContentLayerPos.y,d=d.x-c.touchBeginPos.x+c.currentContentLayerPos.x;450<e&&(e=450);50>e&&(e=50);c.setPosition(cc.p(d,e));c.moveLis&&c.moveLis();return!1}},onTouchEnded:function(a,b){var c=b.getCurrentTarget();c.touchable&&(c.touchBeginPos=null,c.currentContentLayerPos=null)},initPeijian:function(){},hitTest:function(a){var b=a.getPosition();if(a.rectWidth){if(this.isContainPoint(b,
!1,a.rectWidth))return!0}else if(this.isContainPoint(b))return!0;return!1},hitXtsTest:function(a){var b=a.getPosition();return(a=a.getUserData()[1])&&this.isContainPoint(b,!0)&&!this.isContainPoint(a)?!0:!1},isShuangBeiFire:function(){return this._isShuangBeiFire},setShuangBeiFire:function(a){this._isShuangBeiFire=a},setXtsEffect:function(a){this._isXTSEffect=a;this.xtsEffectSprite.setVisible(a);a?this.runXtsAction():this.stopXtsAction()},showDead:function(){this._isDead=!0;var a=cc.Sprite.create("#role_dead.png"),
b=cc.Sprite.create("#ys0.png");this.deadLayer.addChild(a,1);this.deadLayer.addChild(b,1);this.touchable=!1},hideDead:function(){this._isDead=!1;this.touchable=!0;this.deadLayer.removeAllChildren()},changePlane:function(){var a=this.findOnePlane();if(-1!=a){var b=cc.spriteFrameCache.getSpriteFrame("role"+a+".png");this.hero.setSpriteFrame(b)}return a},findOnePlane:function(){for(var a=0;3>a;a++)for(var b=0;b<this.hasUse.length;b++)if(a!=this.hasUse[b])return a;return-1}});
HeroSprite.createSelf=function(){var a=new HeroSprite;a.init();return a};var BulletSprite=cc.Sprite.extend({speed:800,killforce:1750,rectWith:null,init:function(){return this._super()?!0:!1},initWithPlaneIndexLvAndDoubleFlag:function(a,b,c){this.init();this.killforce=50*b*(c?2:1);a="#"+a+"_"+b+".png";c?(c=cc.Sprite.create(a),a=cc.Sprite.create(a),b=c.getTextureRect().width,c.setPosition(cc.p(-b/3,0)),a.setPosition(cc.p(b/3,0)),this.rectWith=2*b/3,this.addChild(c),this.addChild(a)):(c=cc.Sprite.create(a),this.rectWith=c.getTextureRect().width/3,this.addChild(c))},move:function(a){var b=
(a.y-this.getPosition().y)/this.speed;a=cc.MoveTo.create(b,a);var c=this,b=cc.CallFunc.create(function(){c.removeFromParent()});a=cc.Sequence.create([a,b]);this.runAction(a)},destory:function(){this.stopAllActions();this.removeFromParent()},hitTest:function(a){a=a.getPosition();var b=this.getPosition();return Math.abs(b.x-a.x)<this.rectWith+35&&Math.abs(b.y-a.y)<this.rectWith+35?!0:!1},getKill:function(){return this.killforce}});
BulletSprite.createWithPlaneIndexLvAndDoubleFlag=function(a,b,c){var d=new BulletSprite;d.initWithPlaneIndexLvAndDoubleFlag(a,b,c);return d};var DaojuSprite=cc.Sprite.extend({nomalLayer:null,skillNum:null,skillNumSprite:null,lis:null,tar:null,touchable:!1,init:function(){return this._super()?(this.initLayer(),this.initBg(),this.initListenner(),!0):!1},initWithResAndNum:function(a,b){this.skillNum=b;this.init();this.initRes(a);this.initNum()},initLayer:function(){this.nomalLayer=cc.Layer.create();this.addChild(this.nomalLayer)},initBg:function(){var a=cc.Sprite.create("#game_skill_k.png");this.nomalLayer.addChild(a)},initRes:function(a){a=
cc.Sprite.create("#game_skill_"+a+".png");this.nomalLayer.addChild(a)},initNum:function(){this.skillNumSprite=NumSprite.createWithNumAndFile(this.skillNum,res.num_ji);this.skillNumSprite.setPosition(cc.p(10,-10));this.nomalLayer.addChild(this.skillNumSprite)},getNum:function(){return this.skillNum},setNum:function(a){this.skillNum=a;this.skillNumSprite.updateByNum(a)},setOnClickListener:function(a,b){this.lis=a;this.tar=b;this.touchable=!0},onclick:function(){this.lis&&0<this.skillNum&&this.lis.call(this.tar)},
initListenner:function(){cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:this.onTouchBegan,onTouchMoved:null,onTouchEnded:null},this)},onTouchBegan:function(a,b){var c=b.getCurrentTarget();if(c.touchable){var d=a.getLocation();return c.isContainPoint(d)?(c.onclick(),!0):!1}},isContainPoint:function(a){var b=this.getPosition(),c=b.x+20,d=b.y-20,e=b.y+20;return a.x>b.x-20&&a.x<c&&a.y>d&&a.y<e?!0:!1}});
DaojuSprite.createWithResAndNum=function(a,b){var c=new DaojuSprite;c.initWithResAndNum(a,b);return c};var EnemySprite=cc.Sprite.extend({allBlood:null,blood:null,gold:null,score:null,daoju:null,mSprite:null,bloodSprite:null,nomalLayer:null,speed:250,isDisplay:!0,desPos:null,rectWidth:10,isBaoPoPlane:!1,init:function(){return this._super()?(this.initLayer(),!0):!1},initWithResAndBlood:function(a,b,c){this.setBlood(b,b);this.setGoldWithBlood(b);this.speed=c||250;this.initDaoju();this.setScoreWithBlood(b);this.init();this.initEnemySprite(a);this.initBlood()},initLayer:function(){this.nomalLayer=cc.Layer.create();
this.addChild(this.nomalLayer)},initEnemySprite:function(a){8==a&&(this.isBaoPoPlane=!0);this.mSprite=cc.Sprite.create("#enemy"+a+".png");this.nomalLayer.addChild(this.mSprite)},initBlood:function(){this.bloodSprite=new BloodSprite;this.bloodSprite.setPosition(cc.p(0,-30));this.nomalLayer.addChild(this.bloodSprite);this.bloodSprite.setVisible(!1)},initDaoju:function(){0==Math.floor(50*Math.random())&&(this.daoju=Math.floor(5*Math.random()))},getDaoju:function(){return this.daoju},getBlood:function(){return this.blood},
getGold:function(){return this.gold},getScore:function(){return this.score},setBlood:function(a,b){b&&(this.allBlood=b);this.blood=a;0>=this.blood?this.showDestory():null!=this.bloodSprite&&(this.bloodSprite.setVisible(!0),this.bloodSprite.updateByPersent(this.blood/this.allBlood))},moveTo:function(a){this.desPos=a;var b=(this.getPosition().y-a.y)/this.speed;a=cc.MoveTo.create(b,a);var c=this,b=cc.CallFunc.create(function(){c.isBaoPoPlane&&c.setUserData(null);c.removeFromParent()});a=cc.Sequence.create([a,
b]);this.runAction(a)},setGoldWithBlood:function(a){a=1E3*Math.random();this.gold=900>a?1:960>a?10:20},setScoreWithBlood:function(a){this.score=7*parseInt(a/500)},showDestory:function(){this.isDisplay=!1;this.mSprite.setVisible(!1);this.bloodSprite.setVisible(!1);this.stopAllActions();this.explore();this.setUserData(null)},explore:function(){for(var a=[],b=0;4>b;b++){var c=cc.spriteFrameCache.getSpriteFrame("fire_hit"+b+".png");a.push(c)}b=cc.Sprite.create(a[0]);this.nomalLayer.addChild(b);var a=
cc.Animation.create(a,1/30),a=cc.Animate.create(a),d=this,c=cc.CallFunc.create(function(){d.removeFromParent()}),a=cc.Sequence.create([a,c]);b.runAction(a)},changeSpeed:function(a){this.speed=a;this.stopAllActions();this.moveTo(this.desPos)}});EnemySprite.createWithResAndBlood=function(a,b,c){var d=new EnemySprite;d.initWithResAndBlood(a,b,c);return d};var BloodSprite=cc.Sprite.extend({bgSprite:null,bloodSprite:null,ctor:function(){this._super();this.init()},init:function(){return this._super()?(this.initBg(),this.initBlood(),!0):!1},initBg:function(){this.bgSprite=cc.Sprite.create("#enemy_hp0.png");this.addChild(this.bgSprite)},initBlood:function(){this.bloodSprite=cc.Sprite.create("#enemy_hp1.png");this.bloodSprite.setAnchorPoint(0,0.5);this.bloodSprite.setPosition(cc.p(-26.5,0));this.addChild(this.bloodSprite)},updateByPersent:function(a){this.bloodSprite.setScaleX(a)}});var CCEffectStartSprite=cc.Sprite.extend({ctor:function(){this._super();this.init()},init:function(){return this._super()?(this.initEffect(),!0):!1},initEffect:function(){for(var a=cc.Sprite.create("#cc_start_efx0.png"),b=[],c=0;6>c;c++){var d=cc.spriteFrameCache.getSpriteFrame("cc_start_efx"+c+".png");b.push(d)}this.parseAction(a,b);this.addChild(a)},parseAction:function(a,b){var c=cc.Animation.create(b,0.1),c=cc.Animate.create(c),d=cc.CallFunc.create(function(){a.removeFromParent()}),c=cc.Sequence.create([c,
d]);a.runAction(c)}});var CCEffectSprite=cc.Sprite.extend({effect1:null,frames1:null,effect2:null,frames2:null,effect3:null,frames3:null,nomalLayer:null,ctor:function(){this._super();this.init()},init:function(){return this._super()?(this.initLayer(),this.initEffect(),this.startAction(),!0):!1},initLayer:function(){this.nomalLayer=cc.Layer.create();this.addChild(this.nomalLayer)},initEffect:function(){this.effect1=cc.Sprite.create("#cc_efx00.png");var a=cc.spriteFrameCache.getSpriteFrame("cc_efx00.png"),b=cc.spriteFrameCache.getSpriteFrame("cc_efx01.png");
this.frames1=[a,b];this.effect2=cc.Sprite.create("#cc_efx10.png");var a=cc.spriteFrameCache.getSpriteFrame("cc_efx10.png"),b=cc.spriteFrameCache.getSpriteFrame("cc_efx11.png"),c=cc.spriteFrameCache.getSpriteFrame("cc_efx12.png");this.frames2=[a,b,c];this.effect3=cc.Sprite.create("#cc_efx20.png");var a=cc.spriteFrameCache.getSpriteFrame("cc_efx20.png"),b=cc.spriteFrameCache.getSpriteFrame("cc_efx21.png"),c=cc.spriteFrameCache.getSpriteFrame("cc_efx22.png"),d=cc.spriteFrameCache.getSpriteFrame("cc_efx23.png");
this.frames3=[a,b,c,d];this.nomalLayer.addChild(this.effect2);this.nomalLayer.addChild(this.effect1)},parseAction:function(a,b){var c=cc.Animation.create(b,0.1),c=cc.Animate.create(c),c=cc.RepeatForever.create(c);a.runAction(c)},startAction:function(){this.parseAction(this.effect2,this.frames2);this.parseAction(this.effect1,this.frames1)}});var HeDanSprite=cc.Sprite.extend({ctor:function(){this._super();this.init()},init:function(){return this._super()?(this.initEffect(),!0):!1},initEffect:function(){var a=cc.Sprite.create("#cc_efx3.png");this.addChild(a);this.startAction(a)},startAction:function(a){var b=cc.ScaleTo.create(0.5,10),c=this,d=cc.CallFunc.create(function(){c.removeFromParent()}),b=cc.Sequence.create([b,d]);a.runAction(b)}});var LuoshiSprite=cc.Sprite.extend({nomalLayer:null,ctor:function(){this._super();this.init()},init:function(){return this._super()?(this.initLayer(),this.initFire(),this.initLuoshi(),!0):!1},initLayer:function(){this.nomalLayer=cc.Layer.create();this.addChild(this.nomalLayer)},initFire:function(){for(var a=cc.Sprite.create("#rocket_f0.png"),b=[],c=0;4>c;c++){var d=cc.spriteFrameCache.getSpriteFrame("rocket_f"+c+".png");b.push(d)}this.parseAction(a,b);a.setPosition(cc.p(0,45));this.nomalLayer.addChild(a)},
initLuoshi:function(){var a=cc.Sprite.create("#rock101.png"),b=cc.Sprite.create("#rock100.png");a.setPosition(cc.p(0,90));this.nomalLayer.addChild(a);this.nomalLayer.addChild(b)},parseAction:function(a,b){var c=cc.Animation.create(b,0.1),c=cc.Animate.create(c),c=cc.RepeatForever.create(c);a.runAction(c)}});var JingJieSprite=cc.Sprite.extend({nomalLayer:null,quanquan:null,selector:null,ctor:function(a){this.selector=a;this._super();this.init()},init:function(){return this._super()?(this.initLayer(),this.initLine(),this.initGanTanHao(),this.initQuanquan(),!0):!1},initLayer:function(){this.nomalLayer=cc.Layer.create();this.addChild(this.nomalLayer)},initLine:function(){var a=cc.Sprite.create("#ys3.png");a.setScaleY(8);this.nomalLayer.addChild(a);this.startFadeAction(a)},initGanTanHao:function(){var a=
cc.Sprite.create("#ys0.png");this.startFadeAction(a,this.startScaleAction);this.nomalLayer.addChild(a)},initQuanquan:function(){var a=this.quanquan=cc.Sprite.create("#ys2.png");a.setScale(8);a.setVisible(!1);this.nomalLayer.addChild(a)},startFadeAction:function(a,b){var c=cc.FadeTo.create(0.3,0),d=cc.FadeTo.create(0.5,255),c=cc.Sequence.create([c,d]),c=cc.Repeat.create(c,3),e=this;b&&(d=cc.CallFunc.create(function(){setTimeout(function(){cc.director.isPaused()||b.call(e)},800)}),c=cc.Sequence.create([c,
d]));a.runAction(c)},startScaleAction:function(){this.quanquan.setVisible(!0);var a=cc.ScaleTo.create(0.2,1),b=this,c=cc.CallFunc.create(function(){b.selector&&(cc.log(b.getPosition()),b.selector(b.getPosition()));b.removeFromParent()}),a=cc.Sequence.create([a,c]);this.quanquan.runAction(a)}});var DialogSprite=cc.Sprite.extend({showLable:null,init:function(){return this._super()?(this.initBg(),this.initMenu(),this.initLabel(),!0):!1},initWithString:function(a){this.init();this.showLable.setString(a)},initBg:function(){var a=cc.Sprite.create("#ui_k_pet_sel.png");this.addChild(a)},initMenu:function(){var a=cc.Sprite.create("#btn_close.png"),a=cc.MenuItemSprite.create(a,null,null,this.hide,this),b=cc.Menu.create([a]);a.setPosition(cc.p(-15,-70));this.addChild(b)},hide:function(){this.removeFromParent()},
initLabel:function(){this.showLable=cc.LabelTTF.create("","Arial",14,cc.size(220,300));this.addChild(this.showLable)}});DialogSprite.createWithString=function(a){var b=new DialogSprite;b.initWithString(a);return b};var CjDialogSprite=cc.Sprite.extend({giftCallback:null,init:function(){return this._super()?(this.initBg(),this.initMenu(),!0):!1},initShowNewCj:function(){this.init();this.initTitleNewCj();this.initMenuNewCj()},initTitleNewCj:function(){var a=cc.Sprite.create("#cj_ts1.png");a.setPosition(cc.p(0,40));this.addChild(a)},initMenuNewCj:function(){var a=cc.Sprite.create("#cj_ts0.png"),a=cc.MenuItemSprite.create(a,null,null,this.goCj,this),b=cc.Menu.create([a]);a.setPosition(cc.p(-160,-280));this.addChild(b)},
goCj:function(){LoadUtil.getInstance().loadSceneByName("GameCjScene")},initWithGiftAndTitle:function(a,b){this.init();this.initTitle(b);this.initGift(a);this.initGameBtn(b)},initBg:function(){var a=cc.Sprite.create("#ui_ts0.png");this.addChild(a)},initMenu:function(){var a=cc.Sprite.create("#btn_close.png"),a=cc.MenuItemSprite.create(a,null,null,this.hide,this),b=cc.Menu.create([a]);a.setPosition(cc.p(-30,-130));this.addChild(b)},initTitle:function(a){a=0==a?cc.Sprite.create("#cj_jl6.png"):cc.Sprite.create("#cj_jl3.png");
a.setPosition(cc.p(0,80));this.addChild(a)},initGift:function(a){var b=0,c;for(c in a)this.parseGift(c,a[c],b++)},parseGift:function(a,b,c){var d;switch(a){case "gold":d=cc.Sprite.create("#cj_jl4.png");break;case "m1500":d=cc.Sprite.create("#shop_icon1.png");d.setScale(0.5);break;case "m3000":d=cc.Sprite.create("#shop_icon2.png");d.setScale(0.5);break;case "zjhd":d=cc.Sprite.create("#shop_icon3.png");d.setScale(0.5);break;case "jgnl":d=cc.Sprite.create("#shop_icon0.png"),d.setScale(0.5)}a=cc.Sprite.create("#cj_jl5.png");
b=NumSprite.createWithNumAndFile(b,res.num_ji);c=40-40*c;d.setPosition(cc.p(-40,c));a.setPosition(cc.p(0,c));b.setPosition(cc.p(40,c));this.addChild(d);this.addChild(a);this.addChild(b)},initGameBtn:function(a){if(1==a){a=cc.Sprite.create("#cj_jl0.png");a=cc.MenuItemSprite.create(a,null,null,this.getGift,this);var b=cc.Menu.create([a]);a.setPosition(cc.p(-160,-300));this.addChild(b)}},getGift:function(){cc.log("\u9886\u5956\u554a\uff01");this.giftCallback&&this.giftCallback();this.removeFromParent()},
hide:function(){this.removeFromParent()},setGiftGetListenner:function(a){this.giftCallback=a}});CjDialogSprite.createWithGiftAndTitle=function(a,b){var c=new CjDialogSprite;c.initWithGiftAndTitle(a,b);return c};CjDialogSprite.createShowNewCj=function(){var a=new CjDialogSprite;a.initShowNewCj();return a};var BaseLayer=cc.Layer.extend({winSize:null,middlePos:null,init:function(){return this._super()?(this.winSize=cc.director.getWinSize(),this.middlePos=cc.p(this.winSize.width/2,this.winSize.height/2),!0):!1}}),ItemBaseLayer=BaseLayer.extend({bgLayer:null,nomalLayer:null,init:function(a){return this._super()?(this.initBaseLayer(),this.initBackBtn(),this.initTitle(a),!0):!1},initBaseLayer:function(){this.bgLayer=cc.LayerColor.create(cc.color(0,0,0,200));this.addChild(this.bgLayer);this.nomalLayer=cc.Layer.create();
this.addChild(this.nomalLayer)},initBackBtn:function(){var a=cc.Sprite.create("#btn_back.png"),a=cc.MenuItemSprite.create(a,null,null,this.back,this),b=cc.p(-(this.winSize.width/2-45),this.winSize.height/2-30);a.setPosition(b);a=cc.Menu.create([a]);this.nomalLayer.addChild(a,100)},initTitle:function(a){a=cc.Sprite.create(a||"#sel_rw_title.png");var b=cc.p(this.winSize.width/2,this.winSize.height-25);a.setPosition(b);this.nomalLayer.addChild(a)},back:function(){LoadUtil.getInstance().loadSceneByName("GameStartScene")}});var MenuLayer=BaseLayer.extend({mainLayer:null,menuLayer:null,roleLayer:null,init:function(){return this._super()?(this.initLayer(),this.initRole(),this.initMenu(),!0):!1},initLayer:function(){this.roleLayer=cc.Layer.create();this.menuLayer=cc.Layer.create();this.addChild(this.roleLayer);this.addChild(this.menuLayer)},initRole:function(){var a=cc.Sprite.create(res.roleimg);a.setPosition(this.middlePos.x,this.middlePos.y+80);this.roleLayer.addChild(a)},initMenu:function(){var a=cc.Sprite.create("#ui_menu0.png"),
a=cc.MenuItemSprite.create(a,null,null,this.startGame,this);a.setPosition(cc.p(0,-120));this.startMenuAction(a);var b=cc.SpriteBatchNode.create(res.startui);this.menuLayer.addChild(b);var c=cc.Sprite.create("#btn_role.png"),c=cc.MenuItemSprite.create(c,null,null,this.showPlane,this),d=cc.p(0.5*-this.winSize.width+0.125*this.winSize.width,-180);c.setPosition(d);var e=cc.Sprite.create("#btn_k.png");e.setPosition(this.transFormZeroPoint(d));b.addChild(e);var d=cc.Sprite.create("#btn_shop.png"),d=cc.MenuItemSprite.create(d,
null,null,this.showShop,this),f=cc.p(0.5*-this.winSize.width+0.375*this.winSize.width,-180);d.setPosition(f);e=cc.Sprite.create("#btn_k.png");e.setPosition(this.transFormZeroPoint(f));b.addChild(e);var f=cc.Sprite.create("#btn_zt.png"),f=cc.MenuItemSprite.create(f,null,null,this.showZb,this),g=cc.p(0.5*-this.winSize.width+0.625*this.winSize.width,-180);f.setPosition(g);e=cc.Sprite.create("#btn_k.png");e.setPosition(this.transFormZeroPoint(g));b.addChild(e);b=cc.Sprite.create("#ui_cj.png");b=cc.MenuItemSprite.create(b,
null,null,this.showCj,this);e=cc.p(0.5*-this.winSize.width+0.875*this.winSize.width,-180);b.setPosition(e);a=cc.Menu.create([a,c,d,f,b]);this.menuLayer.addChild(a)},transFormZeroPoint:function(a){return cc.p(this.middlePos.x+a.x,this.middlePos.y+a.y)},startMenuAction:function(a){var b=cc.ScaleTo.create(0.7,1.2),c=cc.ScaleTo.create(0.7,1),b=cc.Sequence.create([b,c]),b=cc.RepeatForever.create(b);a.runAction(b)},startGame:function(){this.startNewScene("GameScene")},showPlane:function(){cc.director.runScene(new GameSelectPlaneScene)},
showShop:function(){this.startNewScene("GameShopScene")},showZb:function(){this.startNewScene("GameZbScene")},showCj:function(){this.startNewScene("GameCjScene")},startNewScene:function(a){LoadUtil.getInstance().loadSceneByName(a)}});MenuLayer.createSelf=function(){var a=new MenuLayer;return a&&a.init()?a:null};var PlaneLayer=ItemBaseLayer.extend({mainLayer:null,itemLayer:null,backBtn:null,selectPlane:null,init:function(){return this._super()?(this.initLayer(),this.initPlaneList(),!0):!1},initLayer:function(){this.itemLayer=cc.Layer.create();this.addChild(this.itemLayer)},initPlaneList:function(){for(var a=LocalUtil.getInstance().getPlaneIndex(),b=this.middlePos.y+120,c=0;3>c;c++){var d=a==c,e=PlaneSelectItemSprite.createWithSelectAndPlaneindex(d,c),f=cc.p(this.middlePos.x,b-140*c);e.setPosition(f);e.addOnClickListenner(this.onPlaneItemClick,
this);this.itemLayer.addChild(e);d&&(this.selectPlane=e)}},onPlaneItemClick:function(a){var b=a.getUserData(),c=this.selectPlane.getUserData();b!=c&&(this.selectPlane.unSelect(),a.select(),LocalUtil.getInstance().selectPlaneByIndex(b),this.selectPlane=a)},setVisible:function(a){this._super(a);for(var b=this.itemLayer.getChildren(),c=0;c<b.length;c++)b[c].setTouchEnabled(a)}});PlaneLayer.createSelf=function(){var a=new PlaneLayer;a.init();return a};var ShopLayer=ItemBaseLayer.extend({itemLayer:null,backBtn:null,itemTishiSprite:null,localUtil:null,moneySprite:null,currentSelectItem:null,planeLvSprite:null,init:function(){this.localUtil=LocalUtil.getInstance();return this._super()?(this.itemLayer=cc.Layer.create(),this.addChild(this.itemLayer),this.initTishi(),this.initSelectItems(),this.initMenu(),!0):!1},initTitle:function(){var a=cc.Sprite.create("#title_shop.png"),b=cc.p(this.winSize.width/2-50,this.winSize.height-30);a.setPosition(b);this.nomalLayer.addChild(a);
b=cc.Sprite.create("#shop_k2.png");a=cc.p(this.winSize.width/2+70,this.winSize.height-30);b.setPosition(a);this.nomalLayer.addChild(b);b=this.localUtil.getMoney();b=NumSprite.createWithNumAndFile(b,res.petnum);b.setPosition(a);this.moneySprite=b;this.nomalLayer.addChild(b)},initTishi:function(){var a=this.localUtil.getPlaneIndex(),a=this.localUtil.getPlaneLv(a),a=this.itemTishiSprite=ItemDesSprite.createWithTitleDesAndMoney("\u6b66\u5668\u6539\u9020","\u5347\u7ea7\u4f60\u7684\u57fa\u7840\u6b66\u5668\uff0c\u663e\u8457\u63d0\u5347\u706b\u529b",
100*a);a.setPosition(cc.p(this.winSize.width/2,this.winSize.height-110));this.nomalLayer.addChild(a)},initSelectItems:function(){var a=this.winSize.height/2+35,b=SelectItemConfig.getInstance().getConfig(),c=0,d;for(d in b){var e,f=d,g=b[f];e="#"+g.res;var h=g.linkLayer;0==c?(e=this.localUtil.getPlaneIndex(),h=this.localUtil.getPlaneLv(e),e="#"+(e+1)+"_"+h+".png",this.planeLvSprite=this.currentSelectItem=e=SelectItemSprite.createBulletWithFile(e,h,!0)):h?e=SelectItemSprite.createWithFile(e,void 0,
!1):(h=this.localUtil.getNumByKey(f),e=SelectItemSprite.createWithFile(e,h,!1));e&&(e.setUserData([f,g]),e.addOnClickListenner(this.onSelectItemClick,this),e.setPosition(cc.p(40+c%4*80,a-80*parseInt(c/4))),this.itemLayer.addChild(e));c++}},setVisible:function(a){this._super(a);for(var b=this.itemLayer.getChildren(),c=0;c<b.length;c++)b[c].setTouchEnabled(a)},initMenu:function(){var a=cc.Sprite.create("#btn_buy_role.png"),a=cc.MenuItemSprite.create(a,null,null,this.buy,this),b=cc.Sprite.create("#btn_result_start.png"),
b=cc.MenuItemSprite.create(b,null,null,this.restartGame,this),c=cc.Sprite.create("#btn_result_main.png"),c=cc.MenuItemSprite.create(c,null,null,this.back,this);a.setPosition(cc.p(110,120));b.setPosition(cc.p(-35,-210));c.setPosition(cc.p(120,-210));a=cc.Menu.create([a,b,c]);this.nomalLayer.addChild(a)},onSelectItemClick:function(a){var b=a.getUserData()[1],c=b.desTitle,d=b.des,e=b.buyMoney;(b=b.linkLayer)?LoadUtil.getInstance().loadSceneByName(b):("auto"==e?(e=this.localUtil.getPlaneIndex(),e=this.localUtil.getPlaneLv(e),
this.itemTishiSprite.setTitleAndDesAndMoney(c,d,100*e)):this.itemTishiSprite.setTitleAndDesAndMoney(c,d,e),this.unSelectAllItems(),a.setSelect(!0),this.currentSelectItem=a)},unSelectAllItems:function(){for(var a=this.itemLayer.getChildren(),b=a.length,c=0;c<b;c++)a[c].setSelect(!1)},buy:function(){var a=this.currentSelectItem.getUserData(),b=a[0],a=a[1].buyMoney,c=this.localUtil.getMoney();"auto"==a?(b=this.localUtil.getPlaneIndex(),a=this.localUtil.getPlaneLv(b),35<=a?this.showDiaLog("\u54c8\u54c8\uff0c\u4e3b\u4eba\uff0c\u8fd9\u67b6\u98de\u673a\u5df2\u7ecf\u5347\u5230\u9876\u7ea7\u4e86"):
this.buyPlaneLv(b,a)):c>=a?"cqpj"==b?this.chouPeiJian(a):this.buyDaoJu(b,a):this.showDiaLog("\u563f\uff01\u4e3b\u4eba\uff0c\u4e0d\u8981\u518d\u4e70\u4e86\uff0c\u6ca1\u6709\u94b1\u4e86\uff01\u5feb\u53bb\u8d5a\u94b1\uff01")},buyPlaneLv:function(a,b){var c=this.currentSelectItem,d=this.localUtil.getMoney(),e=100*b;d>=e?(b++,d-=e,this.localUtil.setPlaneLv(a,b),this.localUtil.setMoney(d),this.localUtil.save(),this.moneySprite.updateByNum(d),c.setLv(a,b),this.itemTishiSprite.setMoney(100*b),this.localUtil.addNumByKeyAndSave("totalCostGold",
e)):this.showDiaLog("\u563f\uff01\u4e3b\u4eba\uff0c\u4e0d\u8981\u518d\u4e70\u4e86\uff0c\u6ca1\u6709\u94b1\u4e86\uff01\u5feb\u53bb\u8d5a\u94b1\uff01")},buyDaoJu:function(a,b){var c=this.currentSelectItem,d=this.localUtil.getMoney(),e=this.localUtil.getNumByKey(a);99>e?(e++,d-=b,this.localUtil.setNumByKey(a,e),this.localUtil.setMoney(d),this.localUtil.save(),this.moneySprite.updateByNum(d),c.setNum(e)):(cc.log("\u5df2\u7ecf\u5230\u6700\u5927\u9650\u989d"),this.showDiaLog("\u563f\uff01\u4e3b\u4eba\uff0c\u4e0d\u8981\u518d\u4e70\u4e86\uff0c\u88c5\u4e0d\u4e0b\u4e86"))},
chouPeiJian:function(a){this.showDiaLog("\u6b64\u529f\u80fd\u6b63\u5728\u7814\u53d1\u4e2d\uff0c\u656c\u8bf7\u671f\u5f85")},showDiaLog:function(a){a=DialogSprite.createWithString(a);a.setPosition(this.middlePos);this.addChild(a)},restartGame:function(){LoadUtil.getInstance().loadSceneByName("GameScene")},changePlane:function(a){a=this.localUtil.getPlaneIndex();var b=this.localUtil.getPlaneLv(a);this.planeLvSprite.setLv(a,b);if(this.planeLvSprite.isSelect)this.onSelectItemClick(this.planeLvSprite)}});
ShopLayer.createSelf=function(){var a=new ShopLayer;a.init();return a};var ZhuangBeiLayer=ItemBaseLayer.extend({bgLayer:null,bgSprite:null,buttonLayer:null,lvSprite:null,msgListView:null,init:function(){var a="#ui_role_name"+this.getPlaneIndexAndLv()[0]+".png";return this._super(a)?(this.initLayer(),this.initBg(),this.initButton(),this.initLv(),this.initGameMsg(),this.initMoney(),!0):!1},initLayer:function(){this.bgLayer=cc.Layer.create();this.addChild(this.bgLayer);this.buttonLayer=cc.Layer.create();this.addChild(this.buttonLayer)},initBg:function(){var a=this.getPlaneIndexAndLv()[0];
this.bgSprite=cc.Sprite.create("#ui_role_head"+a+".png");this.bgSprite.setPosition(cc.p(this.middlePos.x,this.middlePos.y+100));this.bgLayer.addChild(this.bgSprite)},initButton:function(){var a=cc.Sprite.create("#ui_cj.png"),b=cc.Sprite.create("#btn_result_shop.png"),c=cc.Sprite.create("#btn_new_pet.png"),d=cc.Sprite.create("#btn_new_pet.png"),a=cc.MenuItemSprite.create(a,null,null,this.goRyLayer,this),b=cc.MenuItemSprite.create(b,null,null,this.goShopLayer,this),c=cc.MenuItemSprite.create(c,null,
null,this.leftzb,this),d=cc.MenuItemSprite.create(d,null,null,this.rightzb,this),e=cc.Menu.create([a,b,c,d]);a.setPosition(cc.p(-100,150));b.setPosition(cc.p(0,-30));c.setPosition(cc.p(-100,50));d.setPosition(cc.p(100,50));this.buttonLayer.addChild(e)},initLv:function(){var a=this.getPlaneIndexAndLv(),a=this.lvSprite=SelectItemSprite.createBulletWithFile("#"+(a[0]+1)+"_"+a[1]+".png",a[1],!1);a.setPosition(cc.p(260,400));this.nomalLayer.addChild(a)},initGameMsg:function(){var a=cc.Sprite.create("#ui_info_k.png");
a.setPosition(cc.p(this.middlePos.x,this.middlePos.y-140));this.nomalLayer.addChild(a);a=this.getItemsFromLocal();a=this.msgListView=ListViewLayer.createWithItems(a,306,145,30);a.setPosition(cc.p(this.middlePos.x,this.middlePos.y-70));this.nomalLayer.addChild(a)},initMoney:function(){var a=cc.Sprite.create("#gold_icon_shop.png");a.setPosition(cc.p(this.middlePos.x+35,this.middlePos.y-30));this.buttonLayer.addChild(a);a=LocalUtil.getInstance().getNumByKey("gold");a=NumSprite.createWithNumAndFile(a,
res.petnum);a.setPosition(cc.p(this.middlePos.x+100,this.middlePos.y-30));this.buttonLayer.addChild(a)},getItemsFromLocal:function(){var a=LocalUtil.getInstance(),b=[],c=["\u6700\u4f73\u524d\u8fdb\u8ddd\u79bb",a.getNumByKey("maxDistanse")];b.push(c);c=["\u6700\u4f73\u5f97\u5206",a.getNumByKey("bestScore")];b.push(c);c=["\u5355\u6b21\u6700\u9ad8\u91d1\u5e01\u83b7\u5f97",a.getNumByKey("onceBestGold")];b.push(c);c=["\u603b\u6e38\u620f\u6570",a.getNumByKey("totalDead")];b.push(c);c=["\u7d2f\u8ba1\u524d\u8fdb\u8ddd\u79bb",
a.getNumByKey("totalDistanse")];b.push(c);c=["\u83b7\u5f97\u91d1\u5e01\u603b\u6570",a.getNumByKey("totalGoldNum")];b.push(c);c=["\u654c\u4eba\u51fb\u6740\u603b\u6570",a.getNumByKey("totalKillNum")];b.push(c);c=["\u91d1\u5e01\u6d88\u8017\u603b\u6570",a.getNumByKey("totalCostGold")];b.push(c);c=["\u83b7\u5f97\u914d\u4ef6\u603b\u6570",a.getNumByKey("totalPj")];b.push(c);for(var a=b.length,d=[],e=0;e<a;e++)c=b[e],c=MsgListViewItem.createWithMsg(c[0],c[1]),d.push(c);return d},goRyLayer:function(){cc.log("\u53bb \u6210\u5c31\u52cb\u7ae0 \u9875");
LoadUtil.getInstance().loadSceneByName("GameCjScene")},goShopLayer:function(){LoadUtil.getInstance().loadSceneByName("GameShopScene")},leftzb:function(){cc.log("\u5de6\u88c5\u5907");this.showDiaLog("\u50da\u673a\u529f\u80fd\u6b63\u5728\u7814\u53d1\u4e2d\uff0c\u656c\u8bf7\u671f\u5f85")},rightzb:function(){cc.log("\u53f3\u88c5\u5907");this.showDiaLog("\u50da\u673a\u529f\u80fd\u6b63\u5728\u7814\u53d1\u4e2d\uff0c\u656c\u8bf7\u671f\u5f85")},showDiaLog:function(a){a=DialogSprite.createWithString(a);a.setPosition(this.middlePos);
this.buttonLayer.addChild(a)},getPlaneIndexAndLv:function(){var a=LocalUtil.getInstance(),b=a.getPlaneIndex(),a=a.getPlaneLv(b);return[b,a]},setVisible:function(a){this._super(a);this.msgListView.setEnable(a)}});ZhuangBeiLayer.createSelf=function(){var a=new ZhuangBeiLayer;a.init();return a};var ListViewLayer=cc.Layer.extend({sprites:[],contentWidth:null,contentHeight:null,spriteHeight:null,contentLayer:null,touchBeginPos:null,touchMovePos:null,currentContentLayerPos:null,touchable:!0,init:function(){return this._super()?(this.initLayer(),this.initItems(),this.initListenner(),this.tick(),!0):!1},initWithItems:function(a,b,c,d){this.sprites=a;this.contentWidth=b;this.contentHeight=c;this.spriteHeight=d;this.init()},initLayer:function(){this.contentLayer=cc.Layer.create();this.addChild(this.contentLayer)},
initItems:function(){var a=this.sprites.length,b=-this.spriteHeight/2;cc.log("len:"+a);for(var c=0;c<a;c++){var d=this.sprites[c];this.contentLayer.addChild(d);var e=cc.p(0,b-this.spriteHeight*c);d.setPosition(e)}},tick:function(){for(var a=this.contentLayer.getChildren(),b=a.length,c=this.contentLayer.getPosition().y,d=0;d<b;d++){var e=a[d],f=e.getPosition().y;0<f+c||0>f+c+this.contentHeight?e.setVisible(!1):e.setVisible(!0)}},resumeLayer:function(){var a=this.contentLayer.getPosition();0>a.y&&this.moveZero();
var b=this.spriteHeight*this.sprites.length-this.contentHeight;a.y>b&&(0<b?this.moveBottem():this.moveZero())},moveZero:function(){var a=this.contentLayer.getPosition();this.moveLayer(cc.p(a.x,0))},moveBottem:function(){var a=this.contentLayer.getPosition();this.moveLayer(cc.p(a.x,this.spriteHeight*this.sprites.length-this.contentHeight))},moveLayer:function(a){a=cc.MoveTo.create(0.2,a);this.schedule(this.tick,0.1,2);this.contentLayer.runAction(a)},setEnable:function(a){this.touchable=a},initListenner:function(){cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,
swallowTouches:!0,onTouchBegan:this.onTouchBegan,onTouchMoved:this.onTouchMoved,onTouchEnded:this.onTouchEnded},this)},isContainPoint:function(a){var b=this.getPosition(),c=b.x+this.contentWidth/2,d=b.y-this.contentHeight,e=b.y;return a.x>b.x-this.contentWidth/2&&a.x<c&&a.y>d&&a.y<e?!0:!1},onTouchBegan:function(a,b){var c=b.getCurrentTarget();if(c.touchable){var d=a.getLocation();return c.isContainPoint(d)?(c.touchBeginPos=a.getLocation(),c.currentContentLayerPos=c.contentLayer.getPosition(),!0):
!1}},onTouchMoved:function(a,b){var c=b.getCurrentTarget();if(c.touchable){var d=a.getLocation().y-c.touchBeginPos.y+c.currentContentLayerPos.y;c.contentLayer.setPosition(cc.p(c.currentContentLayerPos.x,d));c.tick();return!1}},onTouchEnded:function(a,b){var c=b.getCurrentTarget();c.touchable&&(c.touchBeginPos=null,c.currentContentLayerPos=null,c.resumeLayer())},getItemByIndex:function(a){return this.sprites[a]}});
ListViewLayer.createWithItems=function(a,b,c,d){var e=new ListViewLayer;e.initWithItems(a,b,c,d);return e};var CjLayer=ItemBaseLayer.extend({buttonLayer:null,jyListViewLayer:null,jqListViewLayer:null,cjDialogLayer:null,jyButton:null,jqButton:null,jyButtonFrames:null,jqButtonFrames:null,jyListView:null,jqListView:null,init:function(){return this._super("#cj_title.png")?(this.initLayer(),this.initButtonFrame(),this.initButton(),this.initListViewBg(),this.initListView(),!0):!1},initLayer:function(){this.buttonLayer=cc.Layer.create();this.addChild(this.buttonLayer);this.jyListViewLayer=cc.Layer.create();this.addChild(this.jyListViewLayer);
this.jqListViewLayer=cc.Layer.create();this.addChild(this.jqListViewLayer);this.cjDialogLayer=cc.Layer.create();this.addChild(this.cjDialogLayer)},initButtonFrame:function(){var a=cc.spriteFrameCache.getSpriteFrame("cj_btn0.png"),b=cc.spriteFrameCache.getSpriteFrame("cj_btn2.png");this.jyButtonFrames=[a,b];a=cc.spriteFrameCache.getSpriteFrame("cj_btn1.png");b=cc.spriteFrameCache.getSpriteFrame("cj_btn3.png");this.jqButtonFrames=[a,b]},initButton:function(){this.jyButton=cc.Sprite.create(this.jyButtonFrames[0]);
var a=cc.MenuItemSprite.create(this.jyButton,null,null,this.showJy,this);a.setPosition(cc.p(-70,150));this.jqButton=cc.Sprite.create(this.jqButtonFrames[1]);var b=cc.MenuItemSprite.create(this.jqButton,null,null,this.showJq,this);b.setPosition(cc.p(70,150));a=cc.Menu.create([a,b]);this.buttonLayer.addChild(a)},initListViewBg:function(){var a=cc.Sprite.create("#cj_line.png"),b=cc.Sprite.create("#cj_line.png");a.setPosition(cc.p(this.middlePos.x,this.middlePos.y+100));b.setPosition(cc.p(this.middlePos.x,
this.middlePos.y-170));this.nomalLayer.addChild(a);this.nomalLayer.addChild(b)},initListView:function(){var a=this.getJyCjItems(),b=this.getJqCjItems();this.jyListView=ListViewLayer.createWithItems(a,306,230,40);this.jyListView.setPosition(cc.p(this.middlePos.x,this.middlePos.y+80));this.jyListViewLayer.addChild(this.jyListView);this.jqListView=ListViewLayer.createWithItems(b,306,230,40);this.jqListView.setPosition(cc.p(this.middlePos.x,this.middlePos.y+80));this.jqListViewLayer.addChild(this.jqListView);
this.jqListViewLayer.setVisible(!1);this.showJy()},getJyCjItems:function(){var a=LocalUtil.getInstance().getJyMsg();return this.parseCjItem(a,this.jyItemClick)},jyItemClick:function(a){var b=LocalUtil.getInstance().getJyMsg()[a];this.showCjDialog(b.gift,b.hasGet,a,1)},getJqCjItems:function(){var a=LocalUtil.getInstance().getJqMsg();return this.parseCjItem(a,this.jqItemClick)},jqItemClick:function(a){var b=LocalUtil.getInstance().getJqMsg()[a];this.showCjDialog(b.gift,b.hasGet,a,2)},showCjDialog:function(a,
b,c,d){this.cjDialogLayer.removeAllChildren();if(2!=b){var e=CjDialogSprite.createWithGiftAndTitle(a,b);e.setPosition(this.middlePos);this.cjDialogLayer.addChild(e);if(1==b){var f=this;e.setGiftGetListenner(function(){f.excuteGetGift(a);f.excuteChangIltemBtn(c,d)})}}},excuteGetGift:function(a){var b=LocalUtil.getInstance(),c;for(c in a)b.addNumByKey(c,a[c]);b.save()},excuteChangIltemBtn:function(a,b){LocalUtil.getInstance().changeHasGetByIndexAndCjstate(a,b);(1==b?this.jyListView.getItemByIndex(a):
this.jqListView.getItemByIndex(a)).changeBtnAndRemoveLis()},parseCjItem:function(a,b){for(var c=a.length,d=[],e=0;e<c;e++){var f=a[e],f=CjListViewItem.createWithMsg(f.name,f.hasGet,e);b&&f.setOnClickListener(b,this);d.push(f)}return d},showJy:function(){this.jyButton.setSpriteFrame(this.jyButtonFrames[0]);this.jqButton.setSpriteFrame(this.jqButtonFrames[1]);this.showJyListViewLayer()},showJq:function(){this.jyButton.setSpriteFrame(this.jyButtonFrames[1]);this.jqButton.setSpriteFrame(this.jqButtonFrames[0]);
this.showJqListViewLayer()},showJqListViewLayer:function(){this.jqListViewLayer.setVisible(!0);this.jqListView.setEnable(!0);this.jyListViewLayer.setVisible(!1);this.jyListView.setEnable(!1)},showJyListViewLayer:function(){this.jqListViewLayer.setVisible(!1);this.jqListView.setEnable(!1);this.jyListViewLayer.setVisible(!0);this.jyListView.setEnable(!0)},setListViewEnable:function(a){this.jqListViewLayer.isVisible()?this.jqListView.setEnable(a):this.jyListView.setEnable(a)},setVisible:function(a){this._super(a);
this.setListViewEnable(a)}});CjLayer.createSelf=function(){var a=new CjLayer;a.init();return a};var LoaderScene=cc.Scene.extend({_interval:null,_length:0,_count:0,_label:null,_className:"LoaderScene",init:function(){var a=this._bgLayer=cc.LayerColor.create(cc.color(32,32,32,255));a.setPosition(cc.visibleRect.bottomLeft);this.addChild(a,0);var b=this._label=cc.LabelTTF.create("Loading... 0%","Arial",24);b.setPosition(cc.pAdd(cc.visibleRect.center,cc.p(0,0)));b.setColor(cc.color(180,180,180));a.addChild(this._label,10);return!0},_initStage:function(a,b){var c=this._texture2d=new cc.Texture2D;
...
var b=a.resources;a._length=b.length;a._count=0;cc.loader.load(b,function(b,d){a._count=d},function(){a.cb&&a.cb()});a.schedule(a._updatePercent)},_updatePercent:function(){var a=this._count,b=this._length,c;c=Math.min(a/b*100|0,100);this._label.setString("Loading... "+c+"%");a>=b&&this.unschedule(this._updatePercent)}});
LoaderScene.preload=function(a,b){this.loaderScene||(this.loaderScene=new LoaderScene,this.loaderScene.init());this.loaderScene.initWithResources(a,b);cc.director.runScene(this.loaderScene);return this.loaderScene};var GameStartLayer=BaseLayer.extend({init:function(){return this._super()?(cc.spriteFrameCache.removeSpriteFrames(),cc.spriteFrameCache.addSpriteFrames(res.startmenuplist,res.startmenu),cc.spriteFrameCache.addSpriteFrames(res.startuiplist,res.startui),this.initLayer(),!0):!1},initLayer:function(){var a=BgMoveLayer.createWithBgAndSpeed(res.mapbg1,1);this.addChild(a);a=MenuLayer.createSelf();this.addChild(a)}});GameStartLayer.create=function(){var a=new GameStartLayer;return a&&a.init()?a:null};
var GameStartScene=cc.Scene.extend({onEnter:function(){this._super();var a=GameStartLayer.create();this.addChild(a)}});var GameSelectPlaneLayer=BaseLayer.extend({init:function(){return this._super()?(cc.spriteFrameCache.removeSpriteFrames(),cc.spriteFrameCache.addSpriteFrames(res.startmenuplist,res.startmenu),cc.spriteFrameCache.addSpriteFrames(res.startuiplist,res.startui),this.initLayer(),!0):!1},initLayer:function(){var a=BgMoveLayer.createWithBgAndSpeed(res.mapbg1,1);this.addChild(a);a=PlaneLayer.createSelf();this.addChild(a)}});
GameSelectPlaneLayer.create=function(){var a=new GameSelectPlaneLayer;return a&&a.init()?a:null};var GameSelectPlaneScene=cc.Scene.extend({onEnter:function(){this._super();var a=GameSelectPlaneLayer.create();this.addChild(a)}});var GameShopLayer=BaseLayer.extend({init:function(){return this._super()?(cc.spriteFrameCache.removeSpriteFrames(),cc.spriteFrameCache.addSpriteFrames(res.startmenuplist,res.startmenu),cc.spriteFrameCache.addSpriteFrames(res.startuiplist,res.startui),cc.spriteFrameCache.addSpriteFrames(res.bullet_lv_plist,res.bullet_lv),this.initLayer(),!0):!1},initLayer:function(){var a=BgMoveLayer.createWithBgAndSpeed(res.mapbg1,1);this.addChild(a);a=ShopLayer.createSelf();this.addChild(a)}});
GameShopLayer.create=function(){var a=new GameShopLayer;return a&&a.init()?a:null};var GameShopScene=cc.Scene.extend({onEnter:function(){this._super();var a=GameShopLayer.create();this.addChild(a)}});var GameCjLayer=BaseLayer.extend({init:function(){return this._super()?(cc.spriteFrameCache.removeSpriteFrames(),cc.spriteFrameCache.addSpriteFrames(res.startmenuplist,res.startmenu),cc.spriteFrameCache.addSpriteFrames(res.startuiplist,res.startui),cc.spriteFrameCache.addSpriteFrames(res.cj_plist,res.cjimg),this.initLayer(),!0):!1},initLayer:function(){var a=BgMoveLayer.createWithBgAndSpeed(res.mapbg1,1);this.addChild(a);a=CjLayer.createSelf();this.addChild(a)}});
GameCjLayer.create=function(){var a=new GameCjLayer;return a&&a.init()?a:null};var GameCjScene=cc.Scene.extend({onEnter:function(){this._super();var a=GameCjLayer.create();this.addChild(a)}});var GameZbLayer=BaseLayer.extend({init:function(){return this._super()?(cc.spriteFrameCache.removeSpriteFrames(),cc.spriteFrameCache.addSpriteFrames(res.startmenuplist,res.startmenu),cc.spriteFrameCache.addSpriteFrames(res.startuiplist,res.startui),cc.spriteFrameCache.addSpriteFrames(res.bullet_lv_plist,res.bullet_lv),this.initLayer(),!0):!1},initLayer:function(){var a=BgMoveLayer.createWithBgAndSpeed(res.mapbg1,1);this.addChild(a);a=ZhuangBeiLayer.createSelf();this.addChild(a)}});
GameZbLayer.create=function(){var a=new GameZbLayer;return a&&a.init()?a:null};var GameZbScene=cc.Scene.extend({onEnter:function(){this._super();var a=GameZbLayer.create();this.addChild(a)}});var GameLayer=BaseLayer.extend({heroSprite:null,moveLayer:null,effectLayer:null,heroLayer:null,bulletLayer:null,nomallLayer:null,pauseLayer:null,enemyLayer:null,baoshiLayer:null,daojuLayer:null,jingjieLayer:null,luoshiLayer:null,hideDaoJuLayer:null,scoreLabel:null,goldLabel:null,disLabel:null,speed:20,planeIndex:0,planeLv:1,hedanDaoju:null,chongciDaoju:null,isGameOver:!1,chongCiing:!1,killNum:0,score:0,gold:0,distance:0,useDaojuNum:0,chongCiNum:0,chongCiDaoJuNum:0,gameOverTimeout:null,isDeadFirst:!0,
init:function(){return this._super()?(this.initFrameCache(),this.initLayer(),this.initHero(),this.initSchedule(),this.initBeginChongCi(),this.initScoreLable(),this.initGoldLabel(),this.initDisLabel(),this.initDaoju(),this.initPauseBtn(),!0):!1},startLuoshi:function(){var a=LuoshiFactory.getInstance(),b=this,c=this.heroSprite.getPosition();a.createSingleJingJie(cc.p(c.x,350),this.jingjieLayer,function(c){a.createSingleLuoshi(c,b.luoshiLayer)},function(a){var c=b.heroSprite.getPosition(),f=a.getPosition(),
c=cc.MoveTo.create(0.5,cc.p(c.x,f.y));a.runAction(c)})},startManyLuoshi:function(){var a=LuoshiFactory.getInstance(),b=this,c=[1,2,3,4,5,6,7,8];this.schedule(function(){if(!b.heroSprite._isccEffect&&!b.isGameOver){var d=c.length,d=Math.floor(Math.random()*d);cc.log(d);var e=c[d];c.splice(d,1);cc.log(c);cc.log(e);a.createSingleJingJie(cc.p(32*e,350),this.jingjieLayer,function(c){a.createSingleLuoshi(c,b.luoshiLayer)})}},0.5,8)},stopLuoshi:function(){this.jingjieLayer.removeAllChildren();this.luoshiLayer.removeAllChildren()},
initFrameCache:function(){cc.spriteFrameCache.addSpriteFrames(res.bullet_lv_plist,res.bullet_lv);cc.spriteFrameCache.addSpriteFrames(res.spplist,res.spimg);cc.spriteFrameCache.addSpriteFrames(res.daoju_plist,res.daojuimg);cc.spriteFrameCache.addSpriteFrames(res.pause_plist,res.pauseimg);cc.spriteFrameCache.addSpriteFrames(res.effectplist,res.effectimg);cc.spriteFrameCache.addSpriteFrames(res.effect2plist,res.effect2img)},initLayer:function(){var a=this.moveLayer=BgMoveLayer.createWithBgAndSpeed(res.mapbg1,
1);this.addChild(a);this.effectLayer=cc.Layer.create();this.addChild(this.effectLayer);this.enemyLayer=cc.Layer.create();this.addChild(this.enemyLayer);this.baoshiLayer=cc.Layer.create();this.addChild(this.baoshiLayer);this.daojuLayer=cc.Layer.create();this.addChild(this.daojuLayer);this.heroLayer=cc.Layer.create();this.addChild(this.heroLayer);this.bulletLayer=cc.Layer.create();this.addChild(this.bulletLayer);this.nomallLayer=cc.Layer.create();this.addChild(this.nomallLayer);this.jingjieLayer=cc.Layer.create();
this.addChild(this.jingjieLayer);this.luoshiLayer=cc.Layer.create();this.addChild(this.luoshiLayer);this.hideDaoJuLayer=cc.Layer.create();this.addChild(this.hideDaoJuLayer);this.pauseLayer=cc.LayerColor.create(cc.color(0,0,0,200));this.pauseLayer.setVisible(!1);this.addChild(this.pauseLayer)},initHero:function(){this.heroSprite=HeroSprite.createSelf();var a=cc.p(this.middlePos.x,this.middlePos.y-100);this.heroSprite.setPosition(a);this.heroLayer.addChild(this.heroSprite);a=LocalUtil.getInstance();
this.planeIndex=a.getPlaneIndex();this.planeLv=a.getPlaneLv(this.planeIndex)},initSchedule:function(){this.schedule(this.fire,0.05);this.schedule(this.updateDis,1/this.speed);this.schedule(this.initEnemy,2);this.schedule(this.hitTest);setTimeout(this.canLuoshi.bind(this),1E4)},initBeginChongCi:function(){var a=LocalUtil.getInstance(),b=a.getNumByKey("m1500"),a=a.getNumByKey("m3000");cc.log(b);0<b&&0<a?this.showChongCiBtn(1):0<b?this.showChongCiBtn(2):0<a&&this.showChongCiBtn(3)},fire:function(){var a=
this.heroSprite.getPosition(),b=BulletSprite.createWithPlaneIndexLvAndDoubleFlag(this.planeIndex+1,this.planeLv,this.heroSprite.isShuangBeiFire());b.setPosition(cc.p(a.x,a.y+33));this.bulletLayer.addChild(b);b.move(cc.p(a.x,490))},initScoreLable:function(){this.scoreLabel=NumSprite.createWithNumAndFile(0,res.num_ji);this.scoreLabel.setPosition(cc.p(30,this.winSize.height-10));this.nomallLayer.addChild(this.scoreLabel)},initGoldLabel:function(){var a=cc.Sprite.create("#gold_icon_x.png");this.goldLabel=
NumSprite.createWithNumAndFile(0,res.num_ji);a.setPosition(cc.p(30,this.winSize.height-30));this.goldLabel.setPosition(cc.p(60,this.winSize.height-30));this.nomallLayer.addChild(a);this.nomallLayer.addChild(this.goldLabel)},initDisLabel:function(){this.disLabel=NumSprite.createWithNumAndFile(0,res.num_ji);this.disLabel.setPosition(cc.p(this.winSize.width-60,this.winSize.height-30));var a=cc.Sprite.create(res.font_m);a.setPosition(cc.p(this.winSize.width-20,this.winSize.height-30));this.nomallLayer.addChild(this.disLabel);
this.nomallLayer.addChild(a)},initDaoju:function(){var a=LocalUtil.getInstance(),b=a.getNumByKey("zjhd");this.hedanDaoju=DaojuSprite.createWithResAndNum(0,3<b?3:b);a=a.getNumByKey("jgnl");this.chongciDaoju=DaojuSprite.createWithResAndNum(1,3<a?3:a);this.hedanDaoju.setPosition(cc.p(40,30));this.chongciDaoju.setPosition(cc.p(100,30));this.nomallLayer.addChild(this.hedanDaoju);this.nomallLayer.addChild(this.chongciDaoju);this.hedanDaoju.setOnClickListener(this.fireHeDan,this);this.chongciDaoju.setOnClickListener(this.chongCi,
this)},initPauseBtn:function(){var a=cc.Sprite.create("#btn_pause.png"),a=cc.MenuItemSprite.create(a,null,null,this.pauseCall,this);a.setPosition(cc.p(140,-220));a=cc.Menu.create([a]);this.nomallLayer.addChild(a);a=cc.Sprite.create("#pause0.png");a.setPosition(this.winSize.width-30,this.winSize.height-30);this.pauseLayer.addChild(a);a=cc.Sprite.create("#pause3.png");a=cc.MenuItemSprite.create(a,null,null,this.resumeCall,this);a.setPosition(cc.p(0,80));var b=cc.Sprite.create("#pause5.png"),b=cc.MenuItemSprite.create(b,
null,null,this.resetGame,this),c=cc.Sprite.create("#pause4.png"),c=cc.MenuItemSprite.create(c,null,null,this.back,this);c.setPosition(cc.p(0,-80));a=cc.Menu.create([a,b,c]);this.pauseLayer.addChild(a)},initEnemy:function(a,b){for(var c=EnemyFactory.getInstance(),d=Math.floor(3*Math.random()),c=c.createEnemyByZhenXingAndDis(d,this.distance,b),d=0;d<c.length;d++){var e=c[d];e.isBaoPoPlane&&e.setUserData(c);this.enemyLayer.addChild(e)}},pauseCall:function(){cc.director.isPaused()?cc.director.resume():
(this.pauseLayer.setVisible(!0),cc.director.pause());cc.log("\u6682\u505c")},resumeCall:function(){this.pauseLayer.setVisible(!1);cc.director.isPaused()&&cc.director.resume();cc.log("\u8fd4\u56de\u6e38\u620f")},resetGame:function(){this.pauseLayer.setVisible(!1);cc.director.isPaused()&&cc.director.resume();cc.log("\u91cd\u65b0\u5f00\u59cb");this.startNewScene("GameScene")},back:function(){cc.director.isPaused()&&cc.director.resume();this.startNewScene("GameStartScene")},updateDis:function(){this.distance+=
this.heroSprite._isccEffect?5:1;this.disLabel.updateByNum(this.distance)},updateGold:function(a){this.gold+=a;this.goldLabel.updateByNum(this.gold)},fireHeDan:function(){cc.log("\u653e\u6838\u5f39");if(!this.isGameOver){var a=this.hedanDaoju.getNum();if(0<a){this.hedanDaoju.setNum(a-1);a=new HeDanSprite;a.setPosition(this.heroSprite.getPosition());this.exploreAllEnemy();this.effectLayer.addChild(a);var a=LocalUtil.getInstance(),b=a.getNumByKey("zjhd");0<b&&(a.setNumByKey("zjhd",b-1),a.save());this.useDaojuNum++}}},
chongCi:function(){if(!this.isGameOver){var a=this.chongciDaoju.getNum();if(0<a){this.chongciDaoju.setNum(a-1);this.chongci(300);var a=LocalUtil.getInstance(),b=a.getNumByKey("jgnl");0<b&&(a.setNumByKey("jgnl",b-1),a.save());this.chongCiDaoJuNum++;this.useDaojuNum++}}},hitTest:function(){this.isGameOver||(this.bulletHitTest(),this.heroHitTest())},bulletHitTest:function(){for(var a=this.enemyLayer.getChildren(),b=0;b<a.length;b++){var c=a[b];if(c.isDisplay)for(var d=this.bulletLayer.getChildren(),
e=0;e<d.length;e++){var f=d[e];if(f.hitTest(c)&&!(40>f.getPosition().y-this.heroSprite.getPosition().y)){d=c.getBlood()-f.getKill();0>=d&&(c.isBaoPoPlane?this.exploreSameZuEnemy(c):(this.addBaoshi(c),this.addScore(c),this.killNum++));c.setBlood(d);f.destory();break}}}},heroHitTest:function(){this.nomalHeroHitTest();this.heroSprite._isXTSEffect&&this.xtsHeroHitTest()},nomalHeroHitTest:function(){for(var a=this.baoshiLayer.getChildren(),b=0;b<a.length;b++){var c=a[b];if(this.heroSprite.hitTest(c)){var d=
c.getUserData()[0];c.stopAllActions();c.removeFromParent();this.updateGold(d)}}a=this.daojuLayer.getChildren();for(b=0;b<a.length;b++)c=a[b],this.heroSprite.hitTest(c)&&(d=c.getUserData()[0],c.stopAllActions(),c.removeFromParent(),this.executeDaoju(d));a=this.enemyLayer.getChildren();for(b=0;b<a.length;b++)if(c=a[b],c.isDisplay&&this.heroSprite.hitTest(c))if(this.heroSprite._isccEffect)this.exploreOneEnemy(c);else{this.gameOver();break}a=this.luoshiLayer.getChildren();for(b=0;b<a.length;b++)if(this.heroSprite.hitTest(a[b])&&
!this.heroSprite._isccEffect){this.gameOver();break}},xtsHeroHitTest:function(){for(var a=this.baoshiLayer.getChildren(),b=0;b<a.length;b++){var c=a[b];if(this.heroSprite.hitXtsTest(c)){var d=BaoshiFactory.getInstance();d.changeAction(c,this.heroSprite.getPosition())}}a=this.daojuLayer.getChildren();for(b=0;b<a.length;b++)c=a[b],this.heroSprite.hitXtsTest(c)&&(d=BaoshiFactory.getInstance(),d.changeAction(c,this.heroSprite.getPosition()))},addBaoshi:function(a){for(var b=a.getGold(),c=BaoshiFactory.getInstance(),
b=c.createBaoshiByGold(b,a.getPosition()),d=0;d<b.length;d++)this.baoshiLayer.addChild(b[d]);b=a.getDaoju();null!=b&&(a=c.createDaojuBaoshiByIndex(b,a.getPosition()),this.daojuLayer.addChild(a))},addScore:function(a){a=a.getScore();this.score+=a;this.scoreLabel.updateByNum(this.score)},executeDaoju:function(a){cc.log("\u6267\u884c\u9053\u5177\u6548\u679c \u9053\u5177\u7f16\u53f7\uff1a"+a);switch(a){case 0:this.chongci(300);break;case 1:this.shuangbeiFire();break;case 2:case 3:this.addDaoju(a);break;
case 4:this.xtsEffect()}},chongci:function(a,b){cc.log("\u5411\u524d\u51b2\u523a"+a+"\u7c73");if(!this.chongCiing){this.chongCiing=!0;this.ccEffect();this.unschedule(this.removeCcEffect);var c=a/100;this.schedule(this.removeCcEffect,1,1,c);this.stopLuoshi();b?this.schedule(b,1,1,c):this.chongCiNum++}},shuangbeiFire:function(){this.heroSprite.setShuangBeiFire(!0);this.unschedule(this.removeShuangBeiFire);this.schedule(this.removeShuangBeiFire,1,1,5)},removeShuangBeiFire:function(){this.heroSprite.setShuangBeiFire(!1)},
addDaoju:function(a){var b=LocalUtil.getInstance();2==a?(this.hedanDaoju.setNum(this.hedanDaoju.getNum()+1),a=b.getNumByKey("zjhd"),b.setNumByKey("zjhd",a+1),b.save()):3==a&&(this.chongciDaoju.setNum(this.chongciDaoju.getNum()+1),a=b.getNumByKey("jgnl"),b.setNumByKey("jgnl",a+1),b.save())},ccEffect:function(){this.heroSprite.addCcEffect();this.moveLayer.changeSpeed(25);this.changeEnemySpeed();this.unschedule(this.createCcEnemy);this.unschedule(this.initEnemy);this.schedule(this.createCcEnemy,0.2);
this.unschedule(this.fire)},removeCcEffect:function(){this.exploreAllEnemy();this.heroSprite.removeCcEffect();this.moveLayer.changeSpeed(1);this.unschedule(this.createCcEnemy);this.schedule(this.initEnemy,2);this.schedule(this.fire,0.05);this.chongCiing=!1},changeEnemySpeed:function(){for(var a=this.enemyLayer.getChildren(),b=0;b<a.length;b++)a[b].changeSpeed(750)},createCcEnemy:function(){this.initEnemy(0,750)},xtsEffect:function(){this.heroSprite.setXtsEffect(!0);this.unschedule(this.removeXtsEffect);
this.schedule(this.removeXtsEffect,1,1,5)},removeXtsEffect:function(){this.heroSprite.setXtsEffect(!1)},exploreAllEnemy:function(){for(var a=this.enemyLayer.getChildren(),b=0;b<a.length;b++)this.exploreOneEnemy(a[b]);this.stopLuoshi()},exploreSameZuEnemy:function(a){if(a.isBaoPoPlane){a=a.getUserData();for(var b=0;b<a.length;b++){var c=a[b];c.isDisplay&&this.exploreOneEnemy(c)}}},exploreOneEnemy:function(a){this.addBaoshi(a);this.addScore(a);a.setBlood(-1);this.killNum++},canLuoshi:function(){if(!this.isGameOver){var a=
this.distance;if(500<a&&!this.chongCiing){var b=Math.floor(Math.random()*a);b<0.2*a||(b>0.6*a?this.startLuoshi():this.startManyLuoshi());setTimeout(this.canLuoshi.bind(this),5E3>a?2E4:1E4)}else setTimeout(this.canLuoshi.bind(this),1E4)}},gameOver:function(){cc.log("game over");this.isGameOver=!0;cc.director.pause();this.heroSprite.showDead();var a=!1;this.isDeadFirst&&(a=this.showGameOverMenu());var b=1E3;a&&(b=3E3);var c=this;this.gameOverTimeout=setTimeout(function(){cc.director.resume();c.showGameOverLayer()},
b);this.isDeadFirst=!1},showGameOverLayer:function(){var a={dis:this.distance,score:this.score,gold:this.gold,killNum:this.killNum,useDaojuNum:this.useDaojuNum,chongCiNum:this.chongCiNum,chongCiDaoJuNum:this.chongCiDaoJuNum};LoadUtil.getInstance().loadSceneByName("GameOverScene",a)},showGameOverMenu:function(){var a=!1,b=LocalUtil.getInstance(),c=b.getNumByKey("sscc"),b=b.getNumByKey("tszy");0<c&&0<b?(this.showDeadBtn(1),a=!0):0<c?(this.showDeadBtn(2),a=!0):0<b&&(this.showDeadBtn(3),a=!0);return a},
showDeadBtn:function(a){var b;switch(a){case 1:b=cc.Sprite.create("#shop_icon8.png");a=cc.MenuItemSprite.create(b,null,null,this.ssChongci,this);b=cc.Sprite.create("#shop_icon4.png");var c=cc.MenuItemSprite.create(b,null,null,this.tszyEffect,this);b=cc.Menu.create([a,c]);a.setPosition(cc.p(-60,120));c.setPosition(cc.p(60,120));break;case 2:b=cc.Sprite.create("#shop_icon8.png");a=cc.MenuItemSprite.create(b,null,null,this.ssChongci,this);b=cc.Menu.create([a]);a.setPosition(cc.p(0,120));break;case 3:b=
cc.Sprite.create("#shop_icon4.png"),c=cc.MenuItemSprite.create(b,null,null,this.tszyEffect,this),b=cc.Menu.create([c]),c.setPosition(cc.p(0,120))}this.hideDaoJuLayer.addChild(b)},ssChongci:function(){LocalUtil.getInstance().addNumByKeyAndSave("sscc",-1);this.gameOverTimeout&&(clearTimeout(this.gameOverTimeout),this.gameOverTimeout=null);this.isGameOver=!1;this.heroSprite.hideDead();cc.director.resume();var a=this;this.chongci(300,function(){a.showGameOverLayer()});this.hideDaoJuLayer.removeAllChildren()},
tszyEffect:function(){var a=LocalUtil.getInstance();a.addNumByKeyAndSave("tszy",-1);cc.log(this.gameOverTimeout);this.gameOverTimeout&&(clearTimeout(this.gameOverTimeout),this.gameOverTimeout=null);this.isGameOver=!1;this.heroSprite.hideDead();var b=this.heroSprite.changePlane();cc.log("tszyeffect:"+b);-1!=b&&(a=a.getPlaneLv(b),this.planeIndex=b,this.planeLv=a,cc.log(a));cc.director.resume();this.exploreAllEnemy();this.hideDaoJuLayer.removeAllChildren()},showChongCiBtn:function(a){var b;switch(a){case 1:a=
cc.Sprite.create("#shop_icon1.png");a=cc.MenuItemSprite.create(a,null,null,this.chongCi1500,this);var c=cc.Sprite.create("#shop_icon2.png"),c=cc.MenuItemSprite.create(c,null,null,this.chongCi3000,this);b=cc.Menu.create([a,c]);a.setPosition(cc.p(-60,120));c.setPosition(cc.p(60,120));break;case 2:a=cc.Sprite.create("#shop_icon1.png");a=cc.MenuItemSprite.create(a,null,null,this.chongCi1500,this);b=cc.Menu.create([a]);a.setPosition(cc.p(0,120));break;case 3:c=cc.Sprite.create("#shop_icon2.png"),c=cc.MenuItemSprite.create(c,
null,null,this.chongCi3000,this),b=cc.Menu.create([c]),c.setPosition(cc.p(0,120))}this.hideDaoJuLayer.addChild(b);setTimeout(function(){b.removeFromParent()},2E3)},chongCi1500:function(){this.chongci(1500);LocalUtil.getInstance().addNumByKeyAndSave("m1500",-1);this.hideDaoJuLayer.removeAllChildren()},chongCi3000:function(){this.chongci(3E3);LocalUtil.getInstance().addNumByKeyAndSave("m3000",-1);this.hideDaoJuLayer.removeAllChildren()},startNewScene:function(a){LoadUtil.getInstance().loadSceneByName(a)}}),
GameScene=cc.Scene.extend({onEnter:function(){this._super();var a=new GameLayer;a.init();this.addChild(a)}});var GameOverLayer=cc.Layer.extend({msg:null,menuLayer:null,nomalLayer:null,showNewDisFlag:!1,init:function(){return this._super()?(this.refreshData(),this.initFrameCache(),this.initLayer(),this.initButton(),this.initLabel(),this.checkCj(),!0):!1},refreshData:function(){var a=this.msg,b=LocalUtil.getInstance();b.addNumByKey("totalKillNum",a.killNum);b.addNumByKey("totalDistanse",a.dis);b.addNumByKey("totalGoldNum",a.gold);b.addNumByKey("gold",a.gold);b.addNumByKey("totalDead",1);b.addNumByKey("totalUseDaoju",
a.useDaojuNum);var c=b.getNumByKey("maxDistanse"),d=a.dis;d>c&&(this.showNewDisFlag=!0,b.setNumByKey("maxDistanse",d));c=b.getNumByKey("onceBestGold");d=a.gold;d>c&&b.setNumByKey("onceBestGold",d);c=b.getNumByKey("bestScore");d=a.score;d>c&&b.setNumByKey("bestScore",d);c=b.getNumByKey("onceBestChongCi");d=a.chongCiNum;d>c&&b.setNumByKey("onceBestChongCi",d);c=b.getNumByKey("onceBestChongCiDaoJu");a=a.chongCiDaoJuNum;a>c&&b.setNumByKey("onceBestChongCiDaoJu",a);b.save()},initWithMsg:function(a){this.msg=
a;this.init()},initFrameCache:function(){cc.spriteFrameCache.removeSpriteFrames();cc.spriteFrameCache.addSpriteFrames(res.startuiplist,res.startui);cc.spriteFrameCache.addSpriteFrames(res.cjuiplist,res.cjuiimg)},initLayer:function(){var a=BgMoveLayer.createWithBgAndSpeed(res.mapbg1,1);this.addChild(a);a=cc.LayerColor.create(cc.color(0,0,0,100));this.addChild(a);this.nomalLayer=cc.Layer.create();this.addChild(this.nomalLayer);this.menuLayer=cc.Layer.create();this.addChild(this.menuLayer)},initLabel:function(){var a=
cc.Sprite.create("#title_result.png");a.setPosition(cc.p(260,450));this.nomalLayer.addChild(a);a=cc.Sprite.create("#ui_fxjl.png");a.setPosition(cc.p(170,420));this.nomalLayer.addChild(a);a=cc.Sprite.create("#ui_df.png");a.setPosition(cc.p(150,350));this.nomalLayer.addChild(a);a=cc.Sprite.create("#ui_gold.png");a.setPosition(cc.p(150,320));this.nomalLayer.addChild(a);a=LocalUtil.getInstance().getPlaneIndex();a=cc.Sprite.create("#ui_role_head"+a+".png");a.setPosition(cc.p(65,330));this.nomalLayer.addChild(a);
a=cc.Sprite.create("#btn_k.png");a.setPosition(cc.p(285,240));this.nomalLayer.addChild(a);var a=this.msg,b=NumSprite.createWithNumAndFile(a.dis,res.num_ji0);b.setPosition(cc.p(240,380));this.nomalLayer.addChild(b);b=cc.Sprite.create("#mmm_jl0.png");b.setPosition(cc.p(300,380));this.nomalLayer.addChild(b);b=NumSprite.createWithNumAndFile(a.score,res.num_ji);b.setPosition(cc.p(260,350));this.nomalLayer.addChild(b);a=NumSprite.createWithNumAndFile(a.gold,res.num_ji);a.setPosition(cc.p(260,320));this.nomalLayer.addChild(a);
this.showNewDisFlag&&(a=cc.Sprite.create("#best_jl.png"),this.nomalLayer.addChild(a),a.setPosition(cc.p(290,420)),this.shanshuo(a))},initButton:function(){var a=cc.Sprite.create("#btn_result_shop.png"),b=cc.Sprite.create("#btn_result_start.png"),c=cc.Sprite.create("#btn_result_main.png"),d=cc.Sprite.create("#btn_zt.png"),a=cc.MenuItemSprite.create(a,null,null,this.goShop,this),b=cc.MenuItemSprite.create(b,null,null,this.restartGame,this),c=cc.MenuItemSprite.create(c,null,null,this.goMainMenu,this),
d=cc.MenuItemSprite.create(d,null,null,this.goZb,this),e=cc.Menu.create([a,b,c,d]);a.setPosition(cc.p(0,-120));b.setPosition(cc.p(-30,-185));c.setPosition(cc.p(125,-185));d.setPosition(cc.p(125,0));this.menuLayer.addChild(e);a=cc.Sprite.create("#gold_icon_shop.png");a.setPosition(cc.p(200,120));d=LocalUtil.getInstance().getNumByKey("gold");d=NumSprite.createWithNumAndFile(d,res.num_ji);d.setPosition(cc.p(260,120));this.menuLayer.addChild(a);this.menuLayer.addChild(d)},goShop:function(){this.startNewScene("GameShopScene")},
restartGame:function(){this.startNewScene("GameScene")},goMainMenu:function(){this.startNewScene("GameStartScene")},goZb:function(){this.startNewScene("GameZbScene")},startNewScene:function(a){LoadUtil.getInstance().loadSceneByName(a)},shanshuo:function(a){this.schedule(function(){a.isVisible()?a.setVisible(!1):a.setVisible(!0)},0.4)},checkCj:function(){if(LocalUtil.getInstance().checkCj()){var a=CjDialogSprite.createShowNewCj();a.setPosition(cc.p(160,240));this.addChild(a)}}});
GameOverLayer.createWithMsg=function(a){var b=new GameOverLayer;b.initWithMsg(a);return b};var GameOverScene=cc.Scene.extend({msg:null,ctor:function(a){this._super();this.msg=a},onEnter:function(){this._super();var a=GameOverLayer.createWithMsg(this.msg);this.addChild(a)}});cc.game.onStart=function(){cc.view.setDesignResolutionSize(320,480,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);LoadUtil.getInstance().loadSceneByName("GameStartScene")};cc.game.run();