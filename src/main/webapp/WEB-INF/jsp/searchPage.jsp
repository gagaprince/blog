...
<html>
    ...
    <div id="mainbody">
        ...
        <div class="blogs">
            <ul class="bloglist">
                <c:forEach var="searchModel" items="${searchResultMap.searchModels}" varStatus="status">
                    <li>
                        <div class="arrow_box">
                            <div class="ti"></div>
                            <!--三角形-->
                            <div class="ci"></div>
                            <!--圆形-->
                            <h2 class="title"><a href="${searchModel.link}" target="_blank">${searchModel.title}</a></h2>
                            <ul class="textinfo">
                                <c:if test="${not empty searchModel.img}">
                                    <a href="${searchModel.link}"><img src="${searchModel.img}"></a>
                                </c:if>
                                <p>
                                    ${searchModel.content}
                                </p>
                ...
                <c:set var="listpageUri" value="/blog/search/${searchResultMap.key}/"></c:set>
