    ...
    *{
    ...
    padding:0 0 5px 0;
       ...
       <div class="main">
           ...
           <c:forEach var="modelItem" items="${cys13LowModels}" varStatus="status">
           <div class="all">
                <p class="title">${modelItem.code}未来10天数据 cys13：${modelItem.cys13} cyc13：${modelItem.cyc13}</p>
                <table>
                   <thead>
                   <tr>
                       <th>股票代码</th>
                   ...
                   <tbody>
                   <c:forEach var="model" items="${lowcysMap[modelItem.code]}" varStatus="status">
                       <tr>
                           <td>${model.code}</td>
                           <td>${model.open}</td>
                           <td>${model.close}</td>
